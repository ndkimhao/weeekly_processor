...
constant arr_rom : TArrROM := (
	...
	/*      */                                                  --
	/*      */                                                  -- test_uop_jmp_3dd:
	/* ea66 */ x"60",x"20",x"1c",x"7b",                         --     mov A, 123
	/* ea6a */ x"ec",x"20",x"1c",x"e0",x"7b",x"0d",x"d0",       --     jne A, 123, $fail
	/* ea71 */ x"e8",x"20",x"1c",x"e0",x"7b",x"7c",x"ea",       --     jeq A, 123, $_test_uop_jmp_3dd_okay
	/* ea78 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --     _test_uop_jmp_3dd_okay:
	/* ea7c */ x"ec",x"20",x"1c",x"e0",x"7b",x"0d",x"d0",       --     jne A, 123, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_jmp_3di:
	/* ea83 */ x"60",x"20",x"1c",x"7b",                         --     mov A, 123
	/* ea87 */ x"62",x"1c",x"e0",x"64",x"41",x"01",             --     mov [100], 321
	/* ea8d */ x"e9",x"20",x"1c",x"e0",x"64",x"0d",x"d0",       --     jeq A, [100], $fail
	/* ea94 */ x"ed",x"20",x"1c",x"e0",x"64",x"9f",x"ea",       --     jne A, [100], $test_uop_jmp_3di_okay
	/* ea9b */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --     test_uop_jmp_3di_okay:
	/* ea9f */ x"ec",x"20",x"1c",x"e0",x"7b",x"0d",x"d0",       --     jne A, 123, $fail
	/* eaa6 */ x"ee",x"1c",x"e0",x"e0",x"64",x"41",x"01",x"0d",x"d0", --     jne [100], 321, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_jmp_3id:
	/* eaaf */ x"60",x"20",x"1c",x"7b",                         --     mov A, 123
	/* eab3 */ x"62",x"1c",x"e0",x"64",x"41",x"01",             --     mov [100], 321
	/* eab9 */ x"ea",x"1c",x"20",x"e0",x"64",x"0d",x"d0",       --     jeq [100], A, $fail
	/* eac0 */ x"ee",x"1c",x"20",x"e0",x"64",x"cb",x"ea",       --     jne [100], A, $_test_uop_jmp_3id_okay
	/* eac7 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --     _test_uop_jmp_3id_okay:
	/* eacb */ x"ec",x"20",x"1c",x"e0",x"7b",x"0d",x"d0",       --     jne A, 123, $fail
	/* ead2 */ x"ee",x"1c",x"e0",x"e0",x"64",x"41",x"01",x"0d",x"d0", --     jne [100], 321, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_jmp_3ii:
	/* eadb */ x"62",x"e0",x"1c",x"c8",x"00",x"7b",             --     mov [200], 123
	/* eae1 */ x"62",x"1c",x"e0",x"64",x"41",x"01",             --     mov [100], 321
	/* eae7 */ x"eb",x"1c",x"e0",x"e0",x"64",x"c8",x"00",x"0d",x"d0", --     jeq [100], [200], $fail
	/* eaf0 */ x"ef",x"1c",x"e0",x"e0",x"64",x"c8",x"00",x"fd",x"ea", --     jne [100], [200], $_test_uop_jmp_3ii_okay
	/* eaf9 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --     _test_uop_jmp_3ii_okay:
	/* eafd */ x"ee",x"e0",x"1c",x"e0",x"c8",x"00",x"7b",x"0d",x"d0", --     jne [200], 123, $fail
	/* eb06 */ x"ee",x"1c",x"e0",x"e0",x"64",x"41",x"01",x"0d",x"d0", --     jne [100], 321, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_mov_dd:
	/* eb0f */ x"60",x"20",x"1c",x"7b",                         --     mov A, 123
	/* eb13 */ x"ec",x"20",x"1c",x"e0",x"7b",x"0d",x"d0",       --     jne A, 123, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_mov_di:
	/* eb1a */ x"62",x"1c",x"e0",x"64",x"da",x"ff",             --     mov [100], 0xFFDA
	/* eb20 */ x"61",x"20",x"1c",x"64",                         --     mov A, [100]
	/* eb24 */ x"ec",x"20",x"e0",x"e0",x"da",x"ff",x"0d",x"d0", --     jne A, 0xFFDA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_mov_id:
	/* eb2c */ x"62",x"1c",x"e0",x"64",x"ff",x"ff",             --     mov [100], 0xFFFF
	/* eb32 */ x"ee",x"1c",x"e0",x"e0",x"64",x"ff",x"ff",x"0d",x"d0", --     jne [100], 0xFFFF, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_mov_ii:
	/* eb3b */ x"60",x"20",x"1c",x"14",                         --     mov A, 20
	/* eb3f */ x"62",x"1c",x"e0",x"78",x"fa",x"fd",             --     mov [120], 0xFDFA
	/* eb45 */ x"63",x"1c",x"e4",x"64",x"64",x"00",             --     mov [100], [100+A]
	/* eb4b */ x"ee",x"1c",x"e0",x"e0",x"64",x"fa",x"fd",x"0d",x"d0", --     jne [100], 0xFDFA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_bmov_dd:
	/* eb54 */ x"64",x"20",x"e0",x"de",x"af",                   --     bmov A, 0xAFDE
	/* eb59 */ x"ec",x"20",x"e0",x"e0",x"de",x"00",x"0d",x"d0", --     jne A, 0xDE, $fail
	/* eb61 */ x"64",x"20",x"e0",x"fa",x"00",                   --     bmov A, 0xFA
	/* eb66 */ x"ec",x"20",x"e0",x"e0",x"fa",x"00",x"0d",x"d0", --     jne A, 0xFA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_bmov_di:
	/* eb6e */ x"62",x"1c",x"e0",x"64",x"da",x"ff",             --     mov [100], 0xFFDA
	/* eb74 */ x"65",x"20",x"1c",x"64",                         --     bmov A, [100]
	/* eb78 */ x"ec",x"20",x"e0",x"e0",x"da",x"00",x"0d",x"d0", --     jne A, 0xDA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_bmov_id:
	/* eb80 */ x"62",x"1c",x"e0",x"64",x"cd",x"ab",             --     mov [100], 0xABCD
	/* eb86 */ x"62",x"1c",x"e0",x"66",x"34",x"12",             --     mov [102], 0x1234
	/* eb8c */ x"62",x"1c",x"e0",x"68",x"78",x"56",             --     mov [104], 0x5678
	/* eb92 */ x"66",x"1c",x"e0",x"66",x"df",x"00",             --     bmov [102], 0xDF
	/* eb98 */ x"ee",x"1c",x"e0",x"e0",x"64",x"cd",x"ab",x"0d",x"d0", --     jne [100], 0xABCD, $fail
	/* eba1 */ x"ee",x"1c",x"e0",x"e0",x"66",x"df",x"12",x"0d",x"d0", --     jne [102], 0x12DF, $fail
	/* ebaa */ x"ee",x"1c",x"e0",x"e0",x"68",x"78",x"56",x"0d",x"d0", --     jne [104], 0x5678, $fail
	/* ebb3 */ x"66",x"1c",x"e0",x"67",x"b8",x"00",             --     bmov [103], 0xB8
	/* ebb9 */ x"ee",x"1c",x"e0",x"e0",x"64",x"cd",x"ab",x"0d",x"d0", --     jne [100], 0xABCD, $fail
	/* ebc2 */ x"ee",x"1c",x"e0",x"e0",x"66",x"df",x"b8",x"0d",x"d0", --     jne [102], 0xB8DF, $fail
	/* ebcb */ x"ee",x"1c",x"e0",x"e0",x"68",x"78",x"56",x"0d",x"d0", --     jne [104], 0x5678, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_bmov_ii:
	/* ebd4 */ x"62",x"e0",x"e0",x"2c",x"01",x"df",x"00",       --     mov [300], 0xDF
	/* ebdb */ x"62",x"e0",x"e0",x"2e",x"01",x"b8",x"00",       --     mov [302], 0xB8
	/*      */                                                  --
	/* ebe2 */ x"62",x"e0",x"e0",x"c8",x"00",x"cd",x"ab",       --     mov [200], 0xABCD
	/* ebe9 */ x"62",x"e0",x"e0",x"ca",x"00",x"34",x"12",       --     mov [202], 0x1234
	/* ebf0 */ x"62",x"e0",x"e0",x"cc",x"00",x"78",x"56",       --     mov [204], 0x5678
	/* ebf7 */ x"67",x"e0",x"e0",x"ca",x"00",x"2c",x"01",       --     bmov [202], [300]
	/* ebfe */ x"ee",x"e0",x"e0",x"e0",x"c8",x"00",x"cd",x"ab",x"0d",x"d0", --     jne [200], 0xABCD, $fail
	/* ec08 */ x"ee",x"e0",x"e0",x"e0",x"ca",x"00",x"df",x"12",x"0d",x"d0", --     jne [202], 0x12DF, $fail
	/* ec12 */ x"ee",x"e0",x"e0",x"e0",x"cc",x"00",x"78",x"56",x"0d",x"d0", --     jne [204], 0x5678, $fail
	/* ec1c */ x"ee",x"e0",x"e0",x"e0",x"2c",x"01",x"df",x"00",x"0d",x"d0", --     jne [300], 0xDF, $fail
	/* ec26 */ x"ee",x"e0",x"e0",x"e0",x"2e",x"01",x"b8",x"00",x"0d",x"d0", --     jne [302], 0xB8, $fail
	/* ec30 */ x"67",x"e0",x"e0",x"cb",x"00",x"2e",x"01",       --     bmov [203], [302]
	/* ec37 */ x"ee",x"e0",x"e0",x"e0",x"c8",x"00",x"cd",x"ab",x"0d",x"d0", --     jne [200], 0xABCD, $fail
	/* ec41 */ x"ee",x"e0",x"e0",x"e0",x"ca",x"00",x"df",x"b8",x"0d",x"d0", --     jne [202], 0xB8DF, $fail
	/* ec4b */ x"ee",x"e0",x"e0",x"e0",x"cc",x"00",x"78",x"56",x"0d",x"d0", --     jne [204], 0x5678, $fail
	/* ec55 */ x"ee",x"e0",x"e0",x"e0",x"2c",x"01",x"df",x"00",x"0d",x"d0", --     jne [300], 0xDF, $fail
	/* ec5f */ x"ee",x"e0",x"e0",x"e0",x"2e",x"01",x"b8",x"00",x"0d",x"d0", --     jne [302], 0xB8, $fail
	/*      */                                                  --
	/*      */                                                  --
	/*      */                                                  -- test_uop_halt:
	/*      */                                                  --     # Can't test!
	...
	/* ec69 */ x"50",x"1c",x"1c",x"7b",x"2d",                   --     cmp 123, 45
	/* ec6e */ x"4c",x"20",                                     --     getf A
	/* ec70 */ x"ec",x"20",x"1c",x"e0",x"32",x"0d",x"d0",       --     jne A, 0b110010, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_setf: # setf does not support indirection
	/* ec77 */ x"cc",x"e0",x"ff",x"ff",                         --     setf 0xFFFF
	/* ec7b */ x"4c",x"20",                                     --     getf A
	/* ec7d */ x"ec",x"20",x"1c",x"e0",x"3f",x"0d",x"d0",       --     jne A, 0x3F, $fail # masked only 6 bits
	/*      */                                                  --
	/*      */                                                  -- test_uop_call_d:
	/* ec84 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ec89 */ x"60",x"40",x"e0",x"a4",x"ec",                   --     mov B, $_L_test_uop_call_d_fn
	/* ec8e */ x"5c",x"40",                                     --     call B
	/* ec90 */ x"ec",x"40",x"e0",x"e0",x"a4",x"ec",x"0d",x"d0", --     jne B, $_L_test_uop_call_d_fn, $fail
	/* ec98 */ x"ec",x"20",x"e0",x"e0",x"fa",x"34",x"0d",x"d0", --     jne A, 0x34FA, $fail
	/* eca0 */ x"58",x"e0",x"aa",x"ec",                         --     jmp $_L_test_uop_call_d_okay
	/*      */                                                  --     _L_test_uop_call_d_fn:
	/* eca4 */ x"60",x"20",x"e0",x"fa",x"34",                   --     mov A, 0x34FA
	/* eca9 */ x"dc",                                           --     ret
	/*      */                                                  --     _L_test_uop_call_d_okay:
	/*      */                                                  --
	/*      */                                                  -- test_uop_call_i:
	/* ecaa */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ecaf */ x"60",x"40",x"1c",x"64",                         --     mov B, 100
	/* ecb3 */ x"62",x"40",x"e0",x"ce",x"ec",                   --     mov [B], $_L_test_uop_call_i_fn
	/* ecb8 */ x"5e",x"40",                                     --     call [B]
	/* ecba */ x"ee",x"40",x"e0",x"e0",x"ce",x"ec",x"0d",x"d0", --     jne [B], $_L_test_uop_call_i_fn, $fail
	/* ecc2 */ x"ec",x"20",x"e0",x"e0",x"d4",x"aa",x"0d",x"d0", --     jne A, 0xAAD4, $fail
	/* ecca */ x"58",x"e0",x"d4",x"ec",                         --     jmp $_L_test_uop_call_i_okay
	/*      */                                                  --     _L_test_uop_call_i_fn:
	/* ecce */ x"60",x"20",x"e0",x"d4",x"aa",                   --     mov A, 0xAAD4
	/* ecd3 */ x"dc",                                           --     ret
	...
	/*      */                                                  --
	/*      */                                                  -- test_uop_push_d:
	/* ecd4 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ecd9 */ x"60",x"40",x"1c",x"64",                         --     mov B, 100
	/* ecdd */ x"e0",x"40",                                     --     push B
	/* ecdf */ x"ec",x"a0",x"e0",x"e0",x"fe",x"0f",x"0d",x"d0", --     jne SP, 0xFFE, $fail
	/* ece7 */ x"ee",x"e0",x"1c",x"e0",x"fe",x"0f",x"64",x"0d",x"d0", --     jne [0xFFE], 100, $fail
	/* ecf0 */ x"e4",x"60",                                     --     pop C
	/* ecf2 */ x"ec",x"60",x"1c",x"e0",x"64",x"0d",x"d0",       --     jne C, 100, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_push_i:
	/* ecf9 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ecfe */ x"60",x"40",x"1c",x"64",                         --     mov B, 100
	/* ed02 */ x"62",x"40",x"e0",x"90",x"01",                   --     mov [B], 400
	/* ed07 */ x"e2",x"40",                                     --     push [B]
	/* ed09 */ x"ec",x"a0",x"e0",x"e0",x"fe",x"0f",x"0d",x"d0", --     jne SP, 0xFFE, $fail
	/* ed11 */ x"ee",x"e0",x"e0",x"e0",x"fe",x"0f",x"90",x"01",x"0d",x"d0", --     jne [0xFFE], 400, $fail
	/* ed1b */ x"e4",x"60",                                     --     pop C
	/* ed1d */ x"ec",x"60",x"e0",x"e0",x"90",x"01",x"0d",x"d0", --     jne C, 400, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_pop_d:
	/* ed25 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ed2a */ x"e0",x"e0",x"da",x"fa",                         --     push 0xFADA
	/* ed2e */ x"e4",x"20",                                     --     pop A
	/* ed30 */ x"ec",x"20",x"e0",x"e0",x"da",x"fa",x"0d",x"d0", --     jne A, 0xFADA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_pop_i:
	/* ed38 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ed3d */ x"e0",x"e0",x"da",x"f2",                         --     push 0xF2DA
	/* ed41 */ x"e6",x"1c",x"64",                               --     pop [100]
	/* ed44 */ x"ee",x"1c",x"e0",x"e0",x"64",x"da",x"f2",x"0d",x"d0", --     jne [100], 0xF2DA, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_mmap:
	/*      */                                                  --     # mmap/umap does not support indirection
	/* ed4d */ x"62",x"e0",x"e0",x"00",x"30",x"00",x"ff",       --     mov [0x3000], 0xFF00
	/* ed54 */ x"62",x"e0",x"e0",x"00",x"31",x"01",x"ff",       --     mov [0x3100], 0xFF01
	/* ed5b */ x"62",x"e0",x"e0",x"00",x"32",x"02",x"ff",       --     mov [0x3200], 0xFF02
	/*      */                                                  --
	/* ed62 */ x"62",x"e0",x"e0",x"00",x"40",x"00",x"dd",       --     mov [0x4000], 0xDD00
	/* ed69 */ x"62",x"e0",x"e0",x"00",x"41",x"01",x"dd",       --     mov [0x4100], 0xDD01
	/* ed70 */ x"62",x"e0",x"e0",x"00",x"42",x"02",x"dd",       --     mov [0x4200], 0xDD02
	/*      */                                                  --
	/* ed77 */ x"62",x"e0",x"e0",x"00",x"50",x"00",x"ee",       --     mov [0x5000], 0xEE00
	/* ed7e */ x"62",x"e0",x"e0",x"00",x"51",x"01",x"ee",       --     mov [0x5100], 0xEE01
	/* ed85 */ x"62",x"e0",x"e0",x"00",x"52",x"02",x"ee",       --     mov [0x5200], 0xEE02
	/*      */                                                  --
	/* ed8c */ x"60",x"20",x"00",                               --     mov A, 0
	/* ed8f */ x"60",x"40",x"e0",x"00",x"41",                   --     mov B, 0x4100
	/* ed94 */ x"54",x"e0",x"e0",x"1c",x"00",x"31",x"ff",x"32",x"01", --     mmap  0x3100, 0x32FF, 1 # start, end, idx
	/* ed9d */ x"ee",x"e0",x"e0",x"e0",x"00",x"31",x"01",x"dd",x"0d",x"d0", --     jne [0x3100], 0xDD01, $fail
	/* eda7 */ x"ee",x"e0",x"e0",x"e0",x"00",x"32",x"02",x"dd",x"0d",x"d0", --     jne [0x3200], 0xDD02, $fail
	/* edb1 */ x"ee",x"e0",x"e0",x"e0",x"00",x"30",x"00",x"ff",x"0d",x"d0", --     jne [0x3000], 0xFF00, $fail
	/*      */                                                  --
	/* edbb */ x"60",x"40",x"e0",x"00",x"51",                   --     mov B, 0x5100
	/* edc0 */ x"54",x"e0",x"e0",x"1c",x"00",x"32",x"ff",x"32",x"02", --     mmap  0x3200, 0x32FF, 2 # higher priority
	/* edc9 */ x"ee",x"e0",x"e0",x"e0",x"00",x"32",x"01",x"ee",x"0d",x"d0", --     jne [0x3200], 0xEE01, $fail
	/* edd3 */ x"ee",x"e0",x"e0",x"e0",x"00",x"30",x"00",x"ff",x"0d",x"d0", --     jne [0x3000], 0xFF00, $fail
	/* eddd */ x"ee",x"e0",x"e0",x"e0",x"00",x"31",x"01",x"dd",x"0d",x"d0", --     jne [0x3100], 0xDD01, $fail
	/*      */                                                  --
	/* ede7 */ x"d4",x"1c",x"01",                               --     umap 1
	/* edea */ x"ee",x"e0",x"e0",x"e0",x"00",x"31",x"01",x"ff",x"0d",x"d0", --     jne [0x3100], 0xFF01, $fail
	/* edf4 */ x"ee",x"e0",x"e0",x"e0",x"00",x"32",x"01",x"ee",x"0d",x"d0", --     jne [0x3200], 0xEE01, $fail
	/* edfe */ x"ee",x"e0",x"e0",x"e0",x"00",x"30",x"00",x"ff",x"0d",x"d0", --     jne [0x3000], 0xFF00, $fail
	/*      */                                                  --
	/* ee08 */ x"d4",x"1c",x"02",                               --     umap 2
	/* ee0b */ x"ee",x"e0",x"e0",x"e0",x"00",x"30",x"00",x"ff",x"0d",x"d0", --     jne [0x3000], 0xFF00, $fail
	/* ee15 */ x"ee",x"e0",x"e0",x"e0",x"00",x"31",x"01",x"ff",x"0d",x"d0", --     jne [0x3100], 0xFF01, $fail
	/* ee1f */ x"ee",x"e0",x"e0",x"e0",x"00",x"32",x"02",x"ff",x"0d",x"d0", --     jne [0x3200], 0xFF02, $fail
	/*      */                                                  --
	/*      */                                                  -- test_uop_umap:
	/*      */                                                  --     # done above
	...
	/*      */                                                  -- test_call_ret:
	/*      */                                                  --
	/* ee29 */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* ee2e */ x"5c",x"e0",x"a5",x"ee",                         --     call $fn_test_target
	/* ee32 */ x"ec",x"a0",x"e0",x"e0",x"00",x"10",x"0d",x"d0", --     jne SP, 0x1000, $fail
	/*      */                                                  --
	/* ee3a */ x"60",x"20",x"1c",x"0a",                         --     mov A, 10
	/* ee3e */ x"60",x"40",x"00",                               --     mov B, 0
	/* ee41 */ x"60",x"60",x"00",                               --     mov C, 0
	/* ee44 */ x"60",x"80",x"00",                               --     mov D, 0
	/* ee47 */ x"5c",x"e0",x"74",x"ee",                         --     call $fn_recursive
	/*      */                                                  --
	/* ee4b */ x"ec",x"20",x"00",x"e0",x"0d",x"d0",             --     jne A, 0, $fail
	/* ee51 */ x"ec",x"40",x"e0",x"e0",x"3f",x"cf",x"0d",x"d0", --     jne B, 0xcf3f, $fail
	/* ee59 */ x"ec",x"60",x"1c",x"e0",x"2d",x"0d",x"d0",       --     jne C, 0x002d, $fail
	/* ee60 */ x"ec",x"80",x"e0",x"e0",x"97",x"45",x"0d",x"d0", --     jne D, 0x4597, $fail
	/* ee68 */ x"ec",x"a0",x"e0",x"e0",x"00",x"10",x"0d",x"d0", --     jne SP, 0x1000, $fail
	/*      */                                                  --
	/* ee70 */ x"58",x"e0",x"b2",x"ee",                         --     jmp $test_call_ret_end
	/*      */                                                  --
	/*      */                                                  -- fn_recursive:
	/* ee74 */ x"04",x"20",x"1c",x"01",                         --     sub A, 1
	/* ee78 */ x"5c",x"e0",x"9d",x"ee",                         --     call $fn_process_c
	/* ee7c */ x"e8",x"20",x"00",x"e0",x"98",x"ee",             --     jeq A, 0, $fn_recursive_end
	/* ee82 */ x"5c",x"e0",x"74",x"ee",                         --     call $fn_recursive
	/* ee86 */ x"00",x"80",x"60",                               --     add D, C
	/* ee89 */ x"08",x"80",x"1c",x"03",                         --     mul D, 3
	/* ee8d */ x"00",x"40",x"80",                               --     add B, D
	/* ee90 */ x"e0",x"80",                                     --     push D
	/* ee92 */ x"08",x"40",x"1c",x"05",                         --     mul B, 5
	/* ee96 */ x"e4",x"80",                                     --     pop D
	/*      */                                                  -- fn_recursive_end:
	/* ee98 */ x"dc",                                           --     ret
	/* ee99 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --
	/*      */                                                  -- fn_process_c:
	/* ee9d */ x"00",x"60",x"20",                               --     add C, A
	/* eea0 */ x"dc",                                           --     ret
	/* eea1 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --
	/*      */                                                  -- fn_test_target:
	/* eea5 */ x"ec",x"a0",x"e0",x"e0",x"fe",x"0f",x"0d",x"d0", --     jne SP, 0x0ffe, $fail
	/* eead */ x"dc",                                           --     ret
	/* eeae */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  --
	/*      */                                                  -- test_call_ret_end:
	...
	/*      */                                                  -- test_mem_access:
	/* eeb2 */ x"62",x"e0",x"e0",x"00",x"01",x"ed",x"ff",       --     mov [0x100], 0xFFED
	/* eeb9 */ x"ee",x"e0",x"e0",x"e0",x"00",x"01",x"aa",x"00",x"c7",x"ee", --     jne [0x100], 0x00AA, $test_mem_access_check_jmp
	/* eec3 */ x"58",x"e0",x"0d",x"d0",                         --     jmp $fail
	/*      */                                                  -- test_mem_access_check_jmp:
	/*      */                                                  --
	/* eec7 */ x"62",x"e0",x"00",x"00",x"10",                   --     mov [0x1000], 0
	/* eecc */ x"60",x"a0",x"e0",x"00",x"10",                   --     mov SP, 0x1000
	/* eed1 */ x"ee",x"a0",x"00",x"e0",x"0d",x"d0",             --     jne [SP], 0, $fail
	/* eed7 */ x"e0",x"00",                                     --     push 0
	/* eed9 */ x"e0",x"00",                                     --     push 0
	/* eedb */ x"e0",x"00",                                     --     push 0
	/* eedd */ x"e4",x"20",                                     --     pop A
	/* eedf */ x"e4",x"20",                                     --     pop A
	/* eee1 */ x"e4",x"20",                                     --     pop A
	/* eee3 */ x"ec",x"a0",x"e0",x"e0",x"00",x"10",x"0d",x"d0", --     jne SP, 0x1000, $fail
	/* eeeb */ x"ec",x"20",x"00",x"e0",x"0d",x"d0",             --     jne A, 0, $fail
	/*      */                                                  --
	/* eef1 */ x"e0",x"e0",x"02",x"01",                         --     push 0x0102
	/* eef5 */ x"ec",x"a0",x"e0",x"e0",x"fe",x"0f",x"0d",x"d0", --     jne SP, 0xFFE, $fail
	/* eefd */ x"e0",x"e0",x"04",x"03",                         --     push 0x0304
	/* ef01 */ x"ec",x"a0",x"e0",x"e0",x"fc",x"0f",x"0d",x"d0", --     jne SP, 0xFFC, $fail
	/*      */                                                  --
	/* ef09 */ x"ee",x"e0",x"e0",x"e0",x"fe",x"0f",x"02",x"01",x"0d",x"d0", --     jne [0xFFE], 0x0102, $fail
	/* ef13 */ x"ee",x"e0",x"e0",x"e0",x"fc",x"0f",x"04",x"03",x"0d",x"d0", --     jne [0xFFC], 0x0304, $fail
	/*      */                                                  --
	/*      */                                                  --     # unaligned
	/* ef1d */ x"ee",x"e0",x"e0",x"e0",x"fb",x"0f",x"00",x"04",x"0d",x"d0", --     jne [0xFFB], 0x0400, $fail
	/* ef27 */ x"ee",x"e0",x"e0",x"e0",x"fd",x"0f",x"03",x"02",x"0d",x"d0", --     jne [0xFFD], 0x0203, $fail
	/* ef31 */ x"ee",x"e0",x"1c",x"e0",x"ff",x"0f",x"01",x"0d",x"d0", --     jne [0xFFF], 0x0001, $fail
	/*      */                                                  --
	/* ef3a */ x"e4",x"20",                                     --     pop A
	/* ef3c */ x"ec",x"20",x"e0",x"e0",x"04",x"03",x"0d",x"d0", --     jne A, 0x0304, $fail
	/* ef44 */ x"ec",x"a0",x"e0",x"e0",x"fe",x"0f",x"0d",x"d0", --     jne SP, 0xFFE, $fail
	/* ef4c */ x"e4",x"20",                                     --     pop A
	/* ef4e */ x"ec",x"20",x"e0",x"e0",x"02",x"01",x"0d",x"d0", --     jne A, 0x0102, $fail
	/* ef56 */ x"ec",x"a0",x"e0",x"e0",x"00",x"10",x"0d",x"d0", --     jne SP, 0x1000, $fail
	/*      */                                                  --
	...
	/*      */                                                  -- # BEGIN test_cmp.asm
	/*      */                                                  -- test_cmp:
	/* ef5e */ x"cc",x"e0",x"ff",x"ff",                         --     setf 0xFFFF
	/* ef62 */ x"4c",x"20",                                     --     getf A
	/* ef64 */ x"ec",x"20",x"1c",x"e0",x"3f",x"0d",x"d0",       --     jne A, 0x3F, $fail
	/*      */                                                  --
	/* ef6b */ x"cc",x"e0",x"ab",x"ab",                         --     setf 0xABAB
	/* ef6f */ x"4c",x"20",                                     --     getf A
	/* ef71 */ x"ec",x"20",x"1c",x"e0",x"2b",x"0d",x"d0",       --     jne A, 0x2B, $fail
	/*      */                                                  --
	/*      */                                                  --     # unsigned
	/* ef78 */ x"50",x"e0",x"1c",x"ab",x"ff",x"2b",             --     cmp 0xFFAB, 0x2B
	/* ef7e */ x"4c",x"20",                                     --     getf A
	/*      */                                                  --     # GE GT LE LT NE EQ
	/* ef80 */ x"ec",x"20",x"1c",x"e0",x"32",x"0d",x"d0",       --     jne A, 0b110010, $fail
	/*      */                                                  --
	/* ef87 */ x"50",x"1c",x"e0",x"2b",x"ab",x"ff",             --     cmp 0x2B, 0xFFAB
	/* ef8d */ x"4c",x"20",                                     --     getf A
	/* ef8f */ x"ec",x"20",x"1c",x"e0",x"0e",x"0d",x"d0",       --     jne A, 0b001110, $fail
	/*      */                                                  --
	/* ef96 */ x"50",x"e0",x"e0",x"ab",x"ff",x"ab",x"ff",       --     cmp 0xFFAB, 0xFFAB
	/* ef9d */ x"4c",x"20",                                     --     getf A
	/* ef9f */ x"ec",x"20",x"1c",x"e0",x"29",x"0d",x"d0",       --     jne A, 0b101001, $fail
	/*      */                                                  --
	/*      */                                                  --     # signed
	/* efa6 */ x"d0",x"e0",x"1c",x"ab",x"ff",x"2b",             --     icmp 0xFFAB, 0x2B
	/* efac */ x"4c",x"20",                                     --     getf A
	/*      */                                                  --     # GE GT LE LT NE EQ
	/* efae */ x"ec",x"20",x"1c",x"e0",x"0e",x"0d",x"d0",       --     jne A, 0b001110, $fail
	/*      */                                                  --
	/* efb5 */ x"d0",x"1c",x"e0",x"2b",x"ab",x"ff",             --     icmp 0x2B, 0xFFAB
	/* efbb */ x"4c",x"20",                                     --     getf A
	/* efbd */ x"ec",x"20",x"1c",x"e0",x"32",x"0d",x"d0",       --     jne A, 0b110010, $fail
	/*      */                                                  --
	/* efc4 */ x"d0",x"e0",x"e0",x"ab",x"ff",x"ab",x"ff",       --     icmp 0xFFAB, 0xFFAB
	/* efcb */ x"4c",x"20",                                     --     getf A
	/* efcd */ x"ec",x"20",x"1c",x"e0",x"29",x"0d",x"d0",       --     jne A, 0b101001, $fail
	/*      */                                                  -- # END test_cmp.asm
	/*      */                                                  --
	/*      */                                                  -- end_of_test:
	/* efd4 */ x"60",x"20",x"e0",x"ad",x"de",                   --     mov A, 0xDEAD
	/* efd9 */ x"60",x"40",x"e0",x"ef",x"be",                   --     mov B, 0xBEEF
	/* efde */ x"88",x"60",x"20",x"40",                         --     mul C, A, B
	/* efe2 */ x"58",x"e0",x"12",x"d0",                         --     jmp $success
	/*      */                                                  --
	/* efe6 */ x"d8"                                            -- __end_of_rom: halt
); -- arr_rom -------------------------------------------
