...
constant arr_rom : TArrROM := (
	...
	/* d6bf */ x"82",x"e0",x"e4",x"2b",x"39",x"30",x"de",x"fa", --     add [12345], 0xFADE + A, A*4 + B
	...
	/* d6de */ x"82",x"fe",x"2b",x"20",                         --     add [G], A*4 + B, A
	...
	/* d815 */ x"aa",x"2b",x"1c",x"2b",x"85",                   --     shl [A*4 + B], -123, A*4 + B
	/* d81a */ x"ee",x"e0",x"e0",x"e0",x"63",x"03",x"28",x"fc",x"0d",x"d0", --     jne [0x0363], 0xfc28, $fail
	/* d824 */ x"b2",x"2b",x"20",x"20",                         --     or [A*4 + B], A, A
	...
	/* d841 */ x"a6",x"3f",x"e4",x"22",x"f6",x"de",x"fa",       --     ishr [A*4 + -10], 0xFADE + A, A*2
	...
	/* d875 */ x"a2",x"2b",x"e4",x"e4",x"de",x"fa",x"de",x"fa", --     shr [A*4 + B], 0xFADE + A, 0xFADE + A
	...
	/* d959 */ x"8e",x"3f",x"fe",x"e0",x"f6",x"39",x"30",       --     imul [A*4 + -10], G, 12345
	/* d960 */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"ed",x"3b",x"0d",x"d0", --     jne [0x029e], 0x3bed, $fail
	/* d96a */ x"8a",x"fe",x"e4",x"2b",x"de",x"fa",             --     mul [G], 0xFADE + A, A*4 + B
	...
	/* da17 */ x"ae",x"fe",x"2b",x"e4",x"de",x"fa",             --     and [G], A*4 + B, 0xFADE + A
	/* da1d */ x"ee",x"e0",x"e0",x"e0",x"55",x"01",x"00",x"03",x"0d",x"d0", --     jne [0x0155], 0x0300, $fail
	/* da27 */ x"aa",x"20",x"3f",x"fe",x"f6",                   --     shl [A], A*4 + -10, G
	...
	/* db76 */ x"a2",x"22",x"e0",x"1c",x"39",x"30",x"85",       --     shr [A*2], 12345, -123
	...
	/* dcc1 */ x"a6",x"3f",x"20",x"22",x"f6",                   --     ishr [A*4 + -10], A, A*2
	/* dcc6 */ x"ee",x"e0",x"1c",x"e0",x"9e",x"02",x"0a",x"0d",x"d0", --     jne [0x029e], 0x000a, $fail
	/* dccf */ x"b2",x"3f",x"20",x"20",x"f6",                   --     or [A*4 + -10], A, A
	...
	/* dcf0 */ x"8e",x"3f",x"e0",x"3f",x"f6",x"39",x"30",x"f6", --     imul [A*4 + -10], 12345, A*4 + -10
	/* dcf8 */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"2e",x"35",x"0d",x"d0", --     jne [0x029e], 0x352e, $fail
	/* dd02 */ x"a6",x"fe",x"fe",x"22",                         --     ishr [G], G, A*2
	/* dd06 */ x"ee",x"e0",x"1c",x"e0",x"55",x"01",x"15",x"0d",x"d0", --     jne [0x0155], 0x0015, $fail
	/* dd0f */ x"8e",x"20",x"e4",x"3f",x"de",x"fa",x"f6",       --     imul [A], 0xFADE + A, A*4 + -10
	...
	/* dd9e */ x"b2",x"22",x"2b",x"3f",x"f6",                   --     or [A*2], A*4 + B, A*4 + -10
	...
	/* deb4 */ x"b2",x"22",x"2b",x"fe",                         --     or [A*2], A*4 + B, G
	...
	/* df8c */ x"8e",x"2b",x"2b",x"e4",x"de",x"fa",             --     imul [A*4 + B], A*4 + B, 0xFADE + A
	...
	/* dfab */ x"8e",x"fe",x"fe",x"2b",                         --     imul [G], G, A*4 + B
	/* dfaf */ x"ee",x"e0",x"e0",x"e0",x"55",x"01",x"df",x"82",x"0d",x"d0", --     jne [0x0155], 0x82df, $fail
	/* dfb9 */ x"8e",x"3f",x"22",x"22",x"f6",                   --     imul [A*4 + -10], A*2, A*2
	...
	/* e176 */ x"aa",x"22",x"3f",x"e4",x"f6",x"de",x"fa",       --     shl [A*2], A*4 + -10, 0xFADE + A
	...
	/* e237 */ x"b2",x"e0",x"22",x"3f",x"39",x"30",x"f6",       --     or [12345], A*2, A*4 + -10
	/* e23e */ x"ee",x"e0",x"e0",x"e0",x"39",x"30",x"de",x"03",x"0d",x"d0", --     jne [0x3039], 0x03de, $fail
	/* e248 */ x"b2",x"20",x"e4",x"22",x"de",x"fa",             --     or [A], 0xFADE + A, A*2
	/* e24e */ x"ee",x"e0",x"e0",x"e0",x"aa",x"00",x"dc",x"fb",x"0d",x"d0", --     jne [0x00aa], 0xfbdc, $fail
	/* e258 */ x"b6",x"fe",x"3f",x"3f",x"f6",x"f6",             --     xor [G], A*4 + -10, A*4 + -10
	/* e25e */ x"ee",x"e0",x"1c",x"e0",x"55",x"01",x"00",x"0d",x"d0", --     jne [0x0155], 0x0000, $fail
	/* e267 */ x"b6",x"3f",x"20",x"e4",x"f6",x"de",x"fa",       --     xor [A*4 + -10], A, 0xFADE + A
	...
	/* e28b */ x"a2",x"3f",x"fe",x"2b",x"f6",                   --     shr [A*4 + -10], G, A*4 + B
	...
	/* e2a6 */ x"86",x"2b",x"e4",x"1c",x"de",x"fa",x"85",       --     sub [A*4 + B], 0xFADE + A, -123
	/* e2ad */ x"ee",x"e0",x"e0",x"e0",x"63",x"03",x"03",x"fc",x"0d",x"d0", --     jne [0x0363], 0xfc03, $fail
	/* e2b7 */ x"ae",x"e0",x"22",x"22",x"39",x"30",             --     and [12345], A*2, A*2
	...
	/* e2d8 */ x"8e",x"3f",x"2b",x"3f",x"f6",x"f6",             --     imul [A*4 + -10], A*4 + B, A*4 + -10
	/* e2de */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"1a",x"dd",x"0d",x"d0", --     jne [0x029e], 0xdd1a, $fail
	/* e2e8 */ x"a2",x"e0",x"3f",x"1c",x"39",x"30",x"f6",x"85", --     shr [12345], A*4 + -10, -123
	...
	/* e309 */ x"a6",x"e0",x"22",x"e0",x"39",x"30",x"39",x"30", --     ishr [12345], A*2, 12345
	...
	/* e39c */ x"8e",x"fe",x"fe",x"3f",x"f6",                   --     imul [G], G, A*4 + -10
	/* e3a1 */ x"ee",x"e0",x"e0",x"e0",x"55",x"01",x"76",x"7c",x"0d",x"d0", --     jne [0x0155], 0x7c76, $fail
	/* e3ab */ x"8a",x"20",x"e0",x"3f",x"39",x"30",x"f6",       --     mul [A], 12345, A*4 + -10
	...
	/* e3ca */ x"a2",x"3f",x"22",x"e4",x"f6",x"de",x"fa",       --     shr [A*4 + -10], A*2, 0xFADE + A
	/* e3d1 */ x"ee",x"e0",x"1c",x"e0",x"9e",x"02",x"01",x"0d",x"d0", --     jne [0x029e], 0x0001, $fail
	/* e3da */ x"a6",x"20",x"3f",x"2b",x"f6",                   --     ishr [A], A*4 + -10, A*4 + B
	...
	/* e55a */ x"8a",x"2b",x"1c",x"3f",x"85",x"f6",             --     mul [A*4 + B], -123, A*4 + -10
	/* e560 */ x"ee",x"e0",x"e0",x"e0",x"63",x"03",x"16",x"be",x"0d",x"d0", --     jne [0x0363], 0xbe16, $fail
	/* e56a */ x"ae",x"2b",x"1c",x"fe",x"85",                   --     and [A*4 + B], -123, G
	...
	/* e5e7 */ x"a6",x"e0",x"2b",x"2b",x"39",x"30",             --     ishr [12345], A*4 + B, A*4 + B
	/* e5ed */ x"ee",x"e0",x"1c",x"e0",x"39",x"30",x"6c",x"0d",x"d0", --     jne [0x3039], 0x006c, $fail
	/* e5f6 */ x"82",x"2b",x"1c",x"22",x"85",                   --     add [A*4 + B], -123, A*2
	...
	/* e7a6 */ x"ae",x"3f",x"e0",x"e4",x"f6",x"39",x"30",x"de",x"fa", --     and [A*4 + -10], 12345, 0xFADE + A
	/* e7af */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"08",x"30",x"0d",x"d0", --     jne [0x029e], 0x3008, $fail
	/* e7b9 */ x"82",x"20",x"fe",x"22",                         --     add [A], G, A*2
	...
	/* ea6f */ x"8e",x"fe",x"3f",x"e0",x"f6",x"39",x"30",       --     imul [G], A*4 + -10, 12345
	...
	/* ea92 */ x"86",x"22",x"3f",x"fe",x"f6",                   --     sub [A*2], A*4 + -10, G
	...
	/* eac3 */ x"86",x"fe",x"22",x"e4",x"de",x"fa",             --     sub [G], A*2, 0xFADE + A
	/* eac9 */ x"ee",x"e0",x"e0",x"e0",x"55",x"01",x"cc",x"05",x"0d",x"d0", --     jne [0x0155], 0x05cc, $fail
	/* ead3 */ x"82",x"2b",x"e0",x"e0",x"39",x"30",x"39",x"30", --     add [A*4 + B], 12345, 12345
	/* eadb */ x"ee",x"e0",x"e0",x"e0",x"63",x"03",x"72",x"60",x"0d",x"d0", --     jne [0x0363], 0x6072, $fail
	/* eae5 */ x"86",x"3f",x"1c",x"e4",x"f6",x"85",x"de",x"fa", --     sub [A*4 + -10], -123, 0xFADE + A
	/* eaed */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"fd",x"03",x"0d",x"d0", --     jne [0x029e], 0x03fd, $fail
	/* eaf7 */ x"82",x"22",x"22",x"3f",x"f6",                   --     add [A*2], A*2, A*4 + -10
	...
	/* eb17 */ x"8e",x"22",x"20",x"3f",x"f6",                   --     imul [A*2], A, A*4 + -10
	/* eb1c */ x"ee",x"e0",x"e0",x"e0",x"54",x"01",x"ec",x"bc",x"0d",x"d0", --     jne [0x0154], 0xbcec, $fail
	/* eb26 */ x"b2",x"3f",x"fe",x"e4",x"f6",x"de",x"fa",       --     or [A*4 + -10], G, 0xFADE + A
	...
	/* eb45 */ x"a6",x"22",x"20",x"e4",x"de",x"fa",             --     ishr [A*2], A, 0xFADE + A
	...
	/* ec13 */ x"8e",x"20",x"3f",x"20",x"f6",                   --     imul [A], A*4 + -10, A
	/* ec18 */ x"ee",x"e0",x"e0",x"e0",x"aa",x"00",x"ec",x"bc",x"0d",x"d0", --     jne [0x00aa], 0xbcec, $fail
	/* ec22 */ x"b2",x"e0",x"3f",x"fe",x"39",x"30",x"f6",       --     or [12345], A*4 + -10, G
	/* ec29 */ x"ee",x"e0",x"e0",x"e0",x"39",x"30",x"df",x"03",x"0d",x"d0", --     jne [0x3039], 0x03df, $fail
	/* ec33 */ x"82",x"22",x"e0",x"e4",x"39",x"30",x"de",x"fa", --     add [A*2], 12345, 0xFADE + A
	...
	/* edd1 */ x"62",x"3f",x"3f",x"f6",x"f6",                   --     mov [A*4 + -10], A*4 + -10
	/* edd6 */ x"ee",x"e0",x"e0",x"e0",x"9e",x"02",x"9e",x"02",x"0d",x"d0", --     jne [0x029e], 0x029e, $fail
	/* ede0 */ x"62",x"22",x"2b",                               --     mov [A*2], A*4 + B
	...
	/* edfd */ x"62",x"fe",x"3f",x"f6",                         --     mov [G], A*4 + -10
	...
	/* ee1a */ x"62",x"fe",x"22",                               --     mov [G], A*2
	/* ee1d */ x"ee",x"e0",x"e0",x"e0",x"55",x"01",x"54",x"01",x"0d",x"d0", --     jne [0x0155], 0x0154, $fail
	/* ee27 */ x"62",x"3f",x"e4",x"f6",x"de",x"fa",             --     mov [A*4 + -10], 0xFADE + A
	...
	/* ee48 */ x"62",x"3f",x"fe",x"f6",                         --     mov [A*4 + -10], G
	...
	/* ef72 */ x"62",x"22",x"e0",x"39",x"30",                   --     mov [A*2], 12345
	...
	/* ef8f */ x"62",x"e0",x"2b",x"39",x"30",                   --     mov [12345], A*4 + B
	...
	/* efbc */ x"62",x"20",x"22",                               --     mov [A], A*2
	/* efbf */ x"ee",x"e0",x"e0",x"e0",x"aa",x"00",x"54",x"01",x"0d",x"d0", --     jne [0x00aa], 0x0154, $fail
	/* efc9 */ x"62",x"3f",x"e0",x"f6",x"39",x"30",             --     mov [A*4 + -10], 12345
	...
	/* f094 */ x"e0",x"3f",x"f6",                               --     push A*4 + -10
