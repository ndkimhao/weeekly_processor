...
constant arr_rom : TArrROM := (
    ...
    x"60",x"20",x"e0",x"78",x"d4",                   -- d01b |   mov A, $const_data_1
    ...
    x"60",x"20",x"e0",x"7f",x"d4",                   -- d0a0 |   mov A, $const_data_2
    ...
    x"60",x"60",x"e0",x"89",x"d4",                   -- d10a |   mov C, $const_data_3
    ...
    x"60",x"60",x"e0",x"94",x"d4",                   -- d12b |   mov C, $const_data_5
    ...
    x"60",x"60",x"e0",x"99",x"d4",                   -- d155 |   mov C, $const_data_6
    ...
    x"60",x"20",x"e0",x"9f",x"d4",                   -- d17f |   mov A, $const_data_7
    ...
    x"60",x"20",x"e0",x"8e",x"d4",                   -- d1ef |   mov A, $const_data_4
    ...
    x"e8",x"fe",x"00",x"e0",x"68",x"d4",             -- d3d9 |   jeq G, 0, $_L_fn_handle_write_1
    x"60",x"60",x"ff",                               -- d3df |   mov C, H
    x"60",x"fd",x"ff",                               -- d3e2 |   mov F, H
    x"65",x"ff",x"20",                               -- d3e5 |   bmov H, [A]
    x"e8",x"ff",x"00",x"e0",x"68",x"d4",             -- d3e8 |   jeq H, 0, $_L_fn_handle_write_1
    x"44",x"20",                                     -- d3ee |   inc A
    x"5c",x"e0",x"8d",x"d1",                         -- d3f0 |   call $fn_split_command
    x"60",x"40",x"ff",                               -- d3f4 |   mov B, H
                                                     --      | _B_fn_handle_write_2:
    x"fc",x"20",x"40",x"e0",x"28",x"d4",             -- d3f7 |   jge A, B, $_E_fn_handle_write_2
    x"5c",x"e0",x"c5",x"d2",                         -- d3fd |   call $fn_parse_hex_16
    x"e8",x"fe",x"00",x"e0",x"68",x"d4",             -- d401 |   jeq G, 0, $_L_fn_handle_write_1
    ...
    x"fc",x"20",x"40",x"e0",x"28",x"d4",             -- d41a |   jge A, B, $_E_fn_handle_write_2
    x"60",x"60",x"7c",x"02",                         -- d420 |   mov C, C + 0x2
    x"58",x"e0",x"f7",x"d3",                         -- d424 |   jmp $_B_fn_handle_write_2
                                                     --      | _E_fn_handle_write_2:
                                                     --      | _B_fn_handle_write_3:
    x"60",x"20",x"e0",x"98",x"00",                   -- d428 |   mov A, $var_uart_send_buf
    x"62",x"20",x"e0",x"4f",x"4b",                   -- d42d |   mov [A], 0x4b4f
    x"62",x"3c",x"1c",x"02",x"20",                   -- d432 |   mov [A + 0x2], 0x20
    x"60",x"20",x"3c",x"03",                         -- d437 |   mov A, A + 0x3
    x"60",x"40",x"fd",                               -- d43b |   mov B, F
    x"5c",x"e0",x"64",x"d3",                         -- d43e |   call $fn_put_hex_16
    x"62",x"3c",x"1c",x"04",x"20",                   -- d442 |   mov [A + 0x4], 0x20
    x"60",x"20",x"3c",x"05",                         -- d447 |   mov A, A + 0x5
    x"60",x"40",x"60",                               -- d44b |   mov B, C
    x"5c",x"e0",x"64",x"d3",                         -- d44e |   call $fn_put_hex_16
    x"62",x"3c",x"1c",x"04",x"0a",                   -- d452 |   mov [A + 0x4], 0xa
    x"60",x"20",x"e0",x"98",x"00",                   -- d457 |   mov A, $var_uart_send_buf
    x"5c",x"e0",x"4a",x"d0",                         -- d45c |   call $fn_send_data
    x"60",x"ff",x"1c",x"01",                         -- d460 |   mov H, 0x1
    x"58",x"e0",x"6b",x"d4",                         -- d464 |   jmp $_E_fn_handle_write_3
                                                     --      | _L_fn_handle_write_1:
    x"60",x"ff",x"00",                               -- d468 |   mov H, 0
                                                     --      | _E_fn_handle_write_3:
    x"e4",x"fe",                                     -- d46b |   pop G
    x"e4",x"fd",                                     -- d46d |   pop F
    x"e4",x"fc",                                     -- d46f |   pop E
    x"e4",x"60",                                     -- d471 |   pop C
    x"e4",x"40",                                     -- d473 |   pop B
    x"e4",x"20",                                     -- d475 |   pop A
    x"dc",                                           -- d477 |   ret
                                                     --      | end_fn_handle_write:
                                                     --      | 
                                                     --      | SECTION_BEGIN_const_data:
                                                     --      | const_data_1:
    x"52",x"45",x"41",x"44",x"59",x"0a",x"00",       -- d478 |   .data str:"READY\n"
                                                     --      | const_data_2:
    x"4f",x"56",x"45",x"52",x"46",x"4c",x"4f",x"57",x"0a",x"00", -- d47f |   .data str:"OVERFLOW\n"
                                                     --      | const_data_3:
    x"50",x"49",x"4e",x"47",x"00",                   -- d489 |   .data str:"PING"
                                                     --      | const_data_4:
    x"50",x"4f",x"4e",x"47",x"0a",x"00",             -- d48e |   .data str:"PONG\n"
                                                     --      | const_data_5:
    x"52",x"45",x"41",x"44",x"00",                   -- d494 |   .data str:"READ"
                                                     --      | const_data_6:
    x"57",x"52",x"49",x"54",x"45",x"00",             -- d499 |   .data str:"WRITE"
                                                     --      | const_data_7:
    x"49",x"4e",x"56",x"41",x"4c",x"49",x"44",x"0a",x"00", -- d49f |   .data str:"INVALID\n"
