...
61 40 e8 5b ed                 # d61f |   mov B, [${const__FONT_16_12_INDEX} + B]
                               #      | _A_call_20:
e0 1c 0c                       # d624 |   push 0xc
e0 1c 10                       # d627 |   push 0x10
e0 e8 66 e9                    # d62a |   push ${const__FONT_16_12_COMPRESSED} + B
...
60 a0 bc 02                    # dbc3 |   mov SP, SP + 0x2
                               #      | _Z_call_51:
                               #      | _A_call_52:
e0 e0 7d ee                    # dbc7 |   push ${const__str__PONG__endl}
...
e0 e0 59 ee                    # dbe7 |   push ${const__data_1}
...
e0 40                          # dc28 |   push B
e0 20                          # dc2a |   push A
e0 e0 9f ee                    # dc2c |   push ${const__data_2}
...
60 60 e0 83 ee                 # dcca |   mov C, ${const__str__INVALID_RANGE__endl}
fc 20 40 f8 28 00              # dccf |   jge A, B, ${_L_fn_check_addr_range_1}:rel + PC
60 60 e0 92 ee                 # dcd5 |   mov C, ${const__str__NOT_ALIGNED__endl}
...
e0 e0 ae ee                    # ddd4 |   push ${const__data_3}
...
58 f8 10 00                    # dde0 |   jmp ${_cleanup_fn_handle_write}:rel + PC
                               ...
                               #      | _A_call_70:
e0 e0 be ee                    # dde4 |   push ${const__data_4}
...
ee bc 1c f8 04 06 18 00        # de25 |   jne [SP + 0x4], 0x6, ${_E_if_82}:rel + PC
                               #      | _A_call_74:
e0 20                          # de2d |   push A
e0 e0 cd ee                    # de2f |   push ${const__data_5}
...
58 20                          # de3b |   jmp A
                               ...
                               #      | _A_call_75:
e0 20                          # de3d |   push A
e0 e0 d8 ee                    # de3f |   push ${const__data_6}
...
ec fe 00 f8 16 00              # de94 |   jne G, 0, ${_E_if_83}:rel + PC
                               #      | _A_call_78:
e0 e0 ea ee                    # de9a |   push ${const__str__TIMEOUT__endl}
...
58 f8 10 00                    # dea6 |   jmp ${_C_if_83}:rel + PC
                               #      | _E_if_83:
                               #      | _A_call_79:
e0 e0 f3 ee                    # deaa |   push ${const__str__INIT_OK__endl}
...
ec fe 00 f8 16 00              # deec |   jne G, 0, ${_E_if_85}:rel + PC
                               #      | _A_call_82:
e0 e0 ea ee                    # def2 |   push ${const__str__TIMEOUT__endl}
...
e0 e0 fc ee                    # df0a |   push ${const__data_7}
...
5c f8 43 f9                    # df56 |   call ${fn_init_oled}:rel + PC
                               #      | _Z_call_87:
                               #      | _A_call_88:
e0 e0 0e ef                    # df5a |   push ${const__str__DONE__endl}
...
5c f8 98 fa                    # df67 |   call ${fn_deinit_oled}:rel + PC
                               #      | _Z_call_89:
                               #      | _A_call_90:
e0 e0 0e ef                    # df6b |   push ${const__str__DONE__endl}
...
ec fe 00 f8 16 00              # e023 |   jne G, 0, ${_E_if_90}:rel + PC
                               #      | _A_call_97:
e0 e0 ea ee                    # e029 |   push ${const__str__TIMEOUT__endl}
...
e0 e0 14 ef                    # e041 |   push ${const__data_8}
...
58 f8 10 00                    # e04d |   jmp ${_cleanup_fn_handle_write_sd}:rel + PC
                               ...
                               #      | _A_call_99:
e0 e0 be ee                    # e051 |   push ${const__data_4}
...
e0 40                          # e0af |   push B
e0 20                          # e0b1 |   push A
e0 e0 27 ef                    # e0b3 |   push ${const__data_9}
...
d4 20                          # e0e4 |   umap A
                               #      | _A_call_103:
e0 20                          # e0e6 |   push A
e0 e0 3f ef                    # e0e8 |   push ${const__data_10}
...
ee e0 00 f8 12 fa 15 00        # e108 |   jne [${var__g_has_sd_card}], 0, ${_E_if_94}:rel + PC
                               #      | _A_call_105:
e0 e0 4b ef                    # e110 |   push ${const__str__NO_SD__endl}
...
ec fe 1c f8 01 17 00           # e12d |   jne G, 0x1, ${_E_if_99}:rel + PC
                               #      | _A_call_111:
e0 e0 52 ef                    # e134 |   push ${const__str__SHOW_IMG_OK__endl}
...
58 f8 10 00                    # e140 |   jmp ${_C_if_99}:rel + PC
                               #      | _E_if_99:
                               #      | _A_call_112:
e0 e0 5f ef                    # e144 |   push ${const__str__SHOW_IMG_ERROR__endl}
...
ec fe 1c f8 01 17 00           # e256 |   jne G, 0x1, ${_E_if_101}:rel + PC
                               #      | _A_call_115:
e0 e0 6f ef                    # e25d |   push ${const__str__ERASE_SD_OK__endl}
...
58 f8 10 00                    # e269 |   jmp ${_C_if_101}:rel + PC
                               #      | _E_if_101:
                               #      | _A_call_116:
e0 e0 7c ef                    # e26d |   push ${const__str__ERASE_SD_ERROR__endl}
...
62 e0 e0 1e ff 0c e3           # e28e |   mov [0xff1e], ${fn_syscall_entry}
                               #      | _A_call_117:
e0 e0 b0 ef                    # e295 |   push ${const__data_11}
...
60 a0 bc 02                    # e2cb |   mov SP, SP + 0x2
                               ...
                               #      | _Z_if_108:
                               #      | _A_call_134:
e0 e0 02 f0                    # e2cf |   push ${const__str__READY__endl}
...
60 20 ff                       # e2e8 |   mov A, H
                               #      | _A_if_173:
ec fe 00 f8 0a 00              # e2eb |   jne G, 0, ${_E_if_173}:rel + PC
58 f8 ef ff                    # e2f1 |   jmp ${_BA_loop_12}:rel + PC
                               #      | _E_if_173:
                               #      | _C_if_173:
                               #      | _Z_if_173:
60 40 21                       # e2f5 |   mov B, A*2
60 40 e8 8a ef                 # e2f8 |   mov B, ${const__HANDLER_MAP} + -002 + B
e0 20                          # e2fd |   push A
5e 40                          # e2ff |   call [B]
e4 20                          # e301 |   pop A
                               #      | _BZ_loop_12:
...
00 ff e0 1b ee                 # e318 |   add H, ${const__SYSCALL_MAP}
5a ff                          # e31d |   jmp [H]
...
dc                             # e331 |   ret
                               ...
                               #      | _A_call_122:
e0 e0 df ef                    # e332 |   push ${const__data_12}
e0 00                          # e336 |   push 0
e0 00                          # e338 |   push 0
...
60 a0 bc 06                    # e33e |   mov SP, SP + 0x6
                               #      | _Z_call_122:
                               #      | _A_call_123:
e0 e0 e8 ef                    # e342 |   push ${const__data_13}
e0 00                          # e346 |   push 0
...
e8 40 00 f8 21 00              # e395 |   jeq B, 0, ${_E_if_107}:rel + PC
                               #      | _A_call_126:
e0 e0 ef ef                    # e39b |   push ${const__str__FORCED_BOOTLOADER__endl}
...
58 f8 21 00                    # e3b2 |   jmp ${_C_scope_8}:rel + PC
                               ...
                               #      | _A_call_128:
e0 20                          # e3b6 |   push A
e0 e0 cd ee                    # e3b8 |   push ${const__data_5}
...
e8 60 1c f8 0d 29 00           # e420 |   jeq C, 0xd, ${_C_loop_13}:rel + PC
                               #      | _A_if_130:
f0 20 bc f8 1f 19 00           # e427 |   jlt A, SP + 0x1f, ${_E_if_130}:rel + PC
                               #      | _A_call_155:
e0 e0 23 f0                    # e42e |   push ${const__data_16}
...
60 60 ff                       # e457 |   mov C, H
                               #      | _A_if_132:
e8 60 00 f8 0f 00              # e45a |   jeq C, 0, ${_E_if_132}:rel + PC
66 60 00                       # e460 |   bmov [C], 0
44 60                          # e463 |   inc C
58 f8 08 00                    # e465 |   jmp ${_C_if_132}:rel + PC
                               #      | _E_if_132:
60 60 1c ff                    # e469 |   mov C, -1
                               ...
                               #      | _A_call_175:
e0 a0                          # e46d |   push SP
5c f8 f4 02                    # e46f |   call ${fn_parse_command_name}:rel + PC
60 a0 bc 02                    # e473 |   mov SP, SP + 0x2
                               #      | _Z_call_175:
                               #      | _A_if_169:
ec ff 00 f8 16 00              # e477 |   jne H, 0, ${_E_if_169}:rel + PC
                               #      | _A_call_176:
e0 e0 bd f0                    # e47d |   push ${const__str__UNKNOWN_COMMAND__endl}
...
60 80 ff                       # e4aa |   mov D, H
                               #      | _A_if_170:
e8 80 00 f8 0d 00              # e4ad |   jeq D, 0, ${_E_if_170}:rel + PC
66 80 00                       # e4b3 |   bmov [D], 0
58 f8 08 00                    # e4b6 |   jmp ${_C_if_170}:rel + PC
                               #      | _E_if_170:
...
61 20 e0 02 fa                 # e4be |   mov A, [${var__g_num_args}]
                               #      | _A_if_171:
f0 20 1c f8 06 17 00           # e4c3 |   jlt A, 0x6, ${_E_if_171}:rel + PC
                               #      | _A_call_178:
e0 e0 ce f0                    # e4ca |   push ${const__data_17}
...
60 a0 bc 02                    # e4e0 |   mov SP, SP + 0x2
                               #      | _Z_call_179:
                               #      | _A_if_172:
ec fe 00 f8 18 00              # e4e4 |   jne G, 0, ${_E_if_172}:rel + PC
                               #      | _A_call_180:
e0 20                          # e4ea |   push A
e0 e0 e3 f0                    # e4ec |   push ${const__data_18}
...
e0 40                          # e54a |   push B
e0 20                          # e54c |   push A
61 20 e0 0e ff                 # e54e |   mov A, [0xff0e]
e9 20 e0 f8 18 fa 68 00        # e553 |   jeq A, [${var__g_last_button_state}], ${_cleanup_fn_check_button_pressed}:rel + PC
62 e0 20 18 fa                 # e55b |   mov [${var__g_last_button_state}], A
98 fe 20 1c 0c                 # e560 |   getb G, A, 0xc
                               #      | _A_if_112:
e8 fe 00 f8 1c 00              # e565 |   jeq G, 0, ${_E_if_112}:rel + PC
61 fe e0 14 fa                 # e56b |   mov G, [${var__g_sd_slot}]
                               #      | _A_if_113:
f0 fe 00 f8 11 00              # e570 |   jlt G, 0, ${_E_if_113}:rel + PC
48 fe                          # e576 |   dec G
62 e0 fe 14 fa                 # e578 |   mov [${var__g_sd_slot}], G
                               #      | _A_call_142:
5c f8 43 00                    # e57d |   call ${fn_update_code_index_screen}:rel + PC
                               #      | _Z_call_142:
                               #      | _E_if_113:
                               #      | _C_if_113:
                               #      | _Z_if_113:
                               ...
                               #      | _C_if_112:
                               #      | _Z_if_112:
98 fe 20 1c 09                 # e581 |   getb G, A, 0x9
                               #      | _A_if_118:
e8 fe 00 f8 26 00              # e586 |   jeq G, 0, ${_E_if_118}:rel + PC
61 40 e0 14 fa                 # e58c |   mov B, [${var__g_sd_slot}]
c6 e0 40 14 fa                 # e591 |   inc [${var__g_sd_slot}], B
                               #      | _A_call_143:
5c f8 2a 00                    # e596 |   call ${fn_update_code_index_screen}:rel + PC
                               #      | _Z_call_143:
                               #      | _A_if_119:
ee e0 1c f8 14 fa ff 12 00     # e59a |   jne [${var__g_sd_slot}], -1, ${_E_if_119}:rel + PC
62 e0 40 14 fa                 # e5a3 |   mov [${var__g_sd_slot}], B
                               #      | _A_call_144:
5c f8 18 00                    # e5a8 |   call ${fn_update_code_index_screen}:rel + PC
                               #      | _Z_call_144:
                               #      | _E_if_119:
                               #      | _C_if_119:
                               #      | _Z_if_119:
                               ...
                               #      | _C_if_118:
                               #      | _Z_if_118:
98 fe 20 1c 08                 # e5ac |   getb G, A, 0x8
                               #      | _A_if_120:
e8 fe 00 f8 0a 00              # e5b1 |   jeq G, 0, ${_E_if_120}:rel + PC
                               #      | _A_call_153:
5c f8 ba 00                    # e5b7 |   call ${fn_load_code_from_sd}:rel + PC
                               #      | _Z_call_153:
                               #      | _E_if_120:
                               #      | _C_if_120:
                               #      | _Z_if_120:
...
e0 60                          # e5c0 |   push C
60 a0 f4 f0 fd                 # e5c2 |   mov SP, 0xfdf0 + SP
60 a0 bc f6                    # e5c7 |   mov SP, SP + -10
61 60 e0 14 fa                 # e5cb |   mov C, [${var__g_sd_slot}]
e8 60 1c f8 ff 94 00           # e5d0 |   jeq C, -1, ${_L_fn_update_code_index_screen_2}:rel + PC
28 60 1c 08                    # e5d7 |   shl C, 0x8
                               #      | _A_call_136:
e0 60                          # e5db |   push C
e0 1c 03                       # e5dd |   push 0x3
e0 e0 00 02                    # e5e0 |   push 0x200
e0 bc 10                       # e5e4 |   push SP + 0x10
5c f8 57 f0                    # e5e7 |   call ${fn_read_sd}:rel + PC
60 a0 bc 08                    # e5eb |   mov SP, SP + 0x8
                               #      | _Z_call_136:
e8 fe 00 f8 66 00              # e5ef |   jeq G, 0, ${_L_fn_update_code_index_screen_1}:rel + PC
ee bc e0 f8 0a b6 3b 6f 00     # e5f5 |   jne [SP + 0xa], 0x3bb6, ${_L_fn_update_code_index_screen_2}:rel + PC
63 e0 bc 16 fa 0c              # e5fe |   mov [${var__g_sd_jmp_target}], [SP + 0xc]
62 bc 00 16                    # e604 |   mov [SP + 0x16], 0
                               #      | _A_call_137:
5c f8 ad f3                    # e608 |   call ${fn_clear_oled}:rel + PC
                               #      | _Z_call_137:
                               #      | _A_call_138:
e0 bc 0e                       # e60c |   push SP + 0xe
e0 00                          # e60f |   push 0
e0 00                          # e611 |   push 0
5c f8 d2 f4                    # e613 |   call ${fn_draw_str_oled}:rel + PC
60 a0 bc 06                    # e617 |   mov SP, SP + 0x6
                               #      | _Z_call_138:
c5 fe e0 14 fa                 # e61b |   inc G, [${var__g_sd_slot}]
                               #      | _A_call_139:
e0 a0                          # e620 |   push SP
e0 fe                          # e622 |   push G
5c f8 90 eb                    # e624 |   call ${fn_itoa_10}:rel + PC
60 a0 bc 04                    # e628 |   mov SP, SP + 0x4
                               #      | _Z_call_139:
60 fe a0                       # e62c |   mov G, SP
                               #      | _A_loop_14:
                               #      | _BA_loop_14:
65 ff fe                       # e62f |   bmov H, [G]
e8 ff 00 f8 0c 00              # e632 |   jeq H, 0, ${_C_loop_14}:rel + PC
44 fe                          # e638 |   inc G
                               #      | _BZ_loop_14:
58 f8 f5 ff                    # e63a |   jmp ${_BA_loop_14}:rel + PC
                               #      | _C_loop_14:
                               #      | _Z_loop_14:
62 fe 1c 2e                    # e63e |   mov [G], 0x2e
                               #      | _A_call_140:
e0 a0                          # e642 |   push SP
e0 00                          # e644 |   push 0
e0 1c 01                       # e646 |   push 0x1
5c f8 9c f4                    # e649 |   call ${fn_draw_str_oled}:rel + PC
60 a0 bc 06                    # e64d |   mov SP, SP + 0x6
                               #      | _Z_call_140:
58 f8 18 00                    # e651 |   jmp ${_cleanup_fn_update_code_index_screen}:rel + PC
                               #      | _L_fn_update_code_index_screen_1:
                               #      | _A_call_141:
e0 1c 45                       # e655 |   push 0x45
5c f8 00 f8                    # e658 |   call ${fn_show_status}:rel + PC
60 a0 bc 02                    # e65c |   mov SP, SP + 0x2
                               #      | _Z_call_141:
58 f8 09 00                    # e660 |   jmp ${_cleanup_fn_update_code_index_screen}:rel + PC
                               #      | _L_fn_update_code_index_screen_2:
ca e0 00 14 fa                 # e664 |   dec [${var__g_sd_slot}], 0
                               #      | _cleanup_fn_update_code_index_screen:
60 a0 f4 1a 02                 # e669 |   mov SP, 0x21a + SP
e4 60                          # e66e |   pop C
dc                             # e670 |   ret
...
e0 40                          # e675 |   push B
e0 20                          # e677 |   push A
60 a0 f4 f0 fd                 # e679 |   mov SP, 0xfdf0 + SP
61 60 e0 14 fa                 # e67e |   mov C, [${var__g_sd_slot}]
e8 60 1c f8 ff d2 00           # e683 |   jeq C, -1, ${_cleanup_fn_load_code_from_sd}:rel + PC
                               #      | _A_call_145:
e0 1c 2d                       # e68a |   push 0x2d
5c f8 cb f7                    # e68d |   call ${fn_show_status}:rel + PC
60 a0 bc 02                    # e691 |   mov SP, SP + 0x2
                               #      | _Z_call_145:
28 60 1c 08                    # e695 |   shl C, 0x8
                               #      | _A_for_21:
c4 40 00                       # e699 |   inc B, 0
                               #      | _BA_for_21:
fc 40 e0 f8 00 01 6a 00        # e69c |   jge B, 0x100, ${_C_for_21}:rel + PC
                               #      | _A_call_146:
e0 4c                          # e6a4 |   push B + C
e0 1c 03                       # e6a6 |   push 0x3
e0 e0 00 02                    # e6a9 |   push 0x200
e0 bc 06                       # e6ad |   push SP + 0x6
5c f8 8e ef                    # e6b0 |   call ${fn_read_sd}:rel + PC
60 a0 bc 08                    # e6b4 |   mov SP, SP + 0x8
                               #      | _Z_call_146:
e8 fe 00 f8 8e 00              # e6b8 |   jeq G, 0, ${_L_fn_load_code_from_sd_1}:rel + PC
61 20 a0                       # e6be |   mov A, [SP]
61 80 bc 02                    # e6c1 |   mov D, [SP + 0x2]
                               #      | _A_scope_9:
                               #      | _B_scope_9:
ec 20 00 f8 10 00              # e6c5 |   jne A, 0, ${_C_scope_9}:rel + PC
ec 80 00 f8 0a 00              # e6cb |   jne D, 0, ${_C_scope_9}:rel + PC
58 f8 35 00                    # e6d1 |   jmp ${_C_for_21}:rel + PC
                               #      | _C_scope_9:
                               #      | _Z_scope_9:
84 fe 80 20                    # e6d5 |   sub G, D, A
f8 fe e0 f8 fc 01 6d 00        # e6d9 |   jgt G, 0x1fc, ${_L_fn_load_code_from_sd_1}:rel + PC
                               #      | _A_call_147:
e0 fe                          # e6e1 |   push G
e0 bc 06                       # e6e3 |   push SP + 0x6
e0 20                          # e6e6 |   push A
5c f8 a9 ec                    # e6e8 |   call ${fn_memcpy}:rel + PC
60 a0 bc 06                    # e6ec |   mov SP, SP + 0x6
                               #      | _Z_call_147:
                               #      | _A_call_148:
e0 80                          # e6f0 |   push D
e0 20                          # e6f2 |   push A
e0 e0 09 f0                    # e6f4 |   push ${const__data_14}
5c f8 3b e9                    # e6f8 |   call ${fn_printf}:rel + PC
60 a0 bc 06                    # e6fc |   mov SP, SP + 0x6
                               #      | _Z_call_148:
                               #      | _BZ_for_21:
44 40                          # e700 |   inc B
58 f8 9a ff                    # e702 |   jmp ${_BA_for_21}:rel + PC
                               #      | _C_for_21:
                               #      | _Z_for_21:
e8 40 e0 f8 00 01 40 00        # e706 |   jeq B, 0x100, ${_L_fn_load_code_from_sd_1}:rel + PC
99 fe e0 1c 0c ff 0a           # e70e |   getb G, [0xff0c], 0xa
                               #      | _A_if_127:
ec fe 00 f8 2d 00              # e715 |   jne G, 0, ${_E_if_127}:rel + PC
                               #      | _A_call_149:
e0 1c 52                       # e71b |   push 0x52
5c f8 3a f7                    # e71e |   call ${fn_show_status}:rel + PC
60 a0 bc 02                    # e722 |   mov SP, SP + 0x2
                               #      | _Z_call_149:
                               #      | _A_call_150:
e2 e0 16 fa                    # e726 |   push [${var__g_sd_jmp_target}]
e0 e0 18 f0                    # e72a |   push ${const__data_15}
5c f8 05 e9                    # e72e |   call ${fn_printf}:rel + PC
60 a0 bc 04                    # e732 |   mov SP, SP + 0x4
                               #      | _Z_call_150:
                               #      | _A_call_151:
e2 e0 16 fa                    # e736 |   push [${var__g_sd_jmp_target}]
5c f8 30 f7                    # e73a |   call ${fn_jmp_to_target_persisted}:rel + PC
60 a0 bc 02                    # e73e |   mov SP, SP + 0x2
                               #      | _Z_call_151:
                               #      | _E_if_127:
                               #      | _C_if_127:
                               #      | _Z_if_127:
58 f8 13 00                    # e742 |   jmp ${_cleanup_fn_load_code_from_sd}:rel + PC
                               #      | _L_fn_load_code_from_sd_1:
                               #      | _A_call_152:
e0 1c 45                       # e746 |   push 0x45
5c f8 0f f7                    # e749 |   call ${fn_show_status}:rel + PC
60 a0 bc 02                    # e74d |   mov SP, SP + 0x2
                               #      | _Z_call_152:
58 f8 04 00                    # e751 |   jmp ${_cleanup_fn_load_code_from_sd}:rel + PC
                               #      | _cleanup_fn_load_code_from_sd:
60 a0 f4 10 02                 # e755 |   mov SP, 0x210 + SP
e4 20                          # e75a |   pop A
e4 40                          # e75c |   pop B
e4 60                          # e75e |   pop C
e4 80                          # e760 |   pop D
...
e0 20                          # e763 |   push A
61 20 bc 04                    # e765 |   mov A, [SP + 0x4]
                               #      | _A_call_157:
e0 e0 35 f0                    # e769 |   push ${const__str__PING}
e0 20                          # e76d |   push A
5c f8 82 ec                    # e76f |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e773 |   mov SP, SP + 0x4
                               #      | _Z_call_157:
                               #      | _A_if_134:
ec ff 00 f8 0d 00              # e777 |   jne H, 0, ${_E_if_134}:rel + PC
c4 ff 00                       # e77d |   inc H, 0
58 f8 e3 01                    # e780 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_134:
                               #      | _C_if_134:
                               #      | _Z_if_134:
                               #      | _A_call_158:
e0 e0 3a f0                    # e784 |   push ${const__str__READ}
e0 20                          # e788 |   push A
5c f8 67 ec                    # e78a |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e78e |   mov SP, SP + 0x4
                               #      | _Z_call_158:
                               #      | _A_if_136:
ec ff 00 f8 0e 00              # e792 |   jne H, 0, ${_E_if_136}:rel + PC
60 ff 1c 02                    # e798 |   mov H, 0x2
58 f8 c7 01                    # e79c |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_136:
                               #      | _C_if_136:
                               #      | _Z_if_136:
                               #      | _A_call_159:
e0 e0 3f f0                    # e7a0 |   push ${const__str__WRITE}
e0 20                          # e7a4 |   push A
5c f8 4b ec                    # e7a6 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e7aa |   mov SP, SP + 0x4
                               #      | _Z_call_159:
                               #      | _A_if_138:
ec ff 00 f8 0e 00              # e7ae |   jne H, 0, ${_E_if_138}:rel + PC
60 ff 1c 03                    # e7b4 |   mov H, 0x3
58 f8 ab 01                    # e7b8 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_138:
                               #      | _C_if_138:
                               #      | _Z_if_138:
                               #      | _A_call_160:
e0 e0 45 f0                    # e7bc |   push ${const__str__READB}
e0 20                          # e7c0 |   push A
5c f8 2f ec                    # e7c2 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e7c6 |   mov SP, SP + 0x4
                               #      | _Z_call_160:
                               #      | _A_if_140:
ec ff 00 f8 0e 00              # e7ca |   jne H, 0, ${_E_if_140}:rel + PC
60 ff 1c 04                    # e7d0 |   mov H, 0x4
58 f8 8f 01                    # e7d4 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_140:
                               #      | _C_if_140:
                               #      | _Z_if_140:
                               #      | _A_call_161:
e0 e0 4b f0                    # e7d8 |   push ${const__str__WRITEB}
e0 20                          # e7dc |   push A
5c f8 13 ec                    # e7de |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e7e2 |   mov SP, SP + 0x4
                               #      | _Z_call_161:
                               #      | _A_if_142:
ec ff 00 f8 0e 00              # e7e6 |   jne H, 0, ${_E_if_142}:rel + PC
60 ff 1c 05                    # e7ec |   mov H, 0x5
58 f8 73 01                    # e7f0 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_142:
                               #      | _C_if_142:
                               #      | _Z_if_142:
                               #      | _A_call_162:
e0 e0 52 f0                    # e7f4 |   push ${const__str__JMP}
e0 20                          # e7f8 |   push A
5c f8 f7 eb                    # e7fa |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e7fe |   mov SP, SP + 0x4
                               #      | _Z_call_162:
                               #      | _A_if_144:
ec ff 00 f8 0e 00              # e802 |   jne H, 0, ${_E_if_144}:rel + PC
60 ff 1c 06                    # e808 |   mov H, 0x6
58 f8 57 01                    # e80c |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_144:
                               #      | _C_if_144:
                               #      | _Z_if_144:
                               #      | _A_call_163:
e0 e0 56 f0                    # e810 |   push ${const__str__JMP_PERSIST}
e0 20                          # e814 |   push A
5c f8 db eb                    # e816 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e81a |   mov SP, SP + 0x4
                               #      | _Z_call_163:
                               #      | _A_if_146:
ec ff 00 f8 0e 00              # e81e |   jne H, 0, ${_E_if_146}:rel + PC
60 ff 1c 07                    # e824 |   mov H, 0x7
58 f8 3b 01                    # e828 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_146:
                               #      | _C_if_146:
                               #      | _Z_if_146:
                               #      | _A_call_164:
e0 e0 62 f0                    # e82c |   push ${const__str__INIT_SD}
e0 20                          # e830 |   push A
5c f8 bf eb                    # e832 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e836 |   mov SP, SP + 0x4
                               #      | _Z_call_164:
                               #      | _A_if_148:
ec ff 00 f8 0e 00              # e83a |   jne H, 0, ${_E_if_148}:rel + PC
60 ff 1c 08                    # e840 |   mov H, 0x8
58 f8 1f 01                    # e844 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_148:
                               #      | _C_if_148:
                               #      | _Z_if_148:
                               #      | _A_call_165:
e0 e0 6a f0                    # e848 |   push ${const__str__READ_SD}
e0 20                          # e84c |   push A
5c f8 a3 eb                    # e84e |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e852 |   mov SP, SP + 0x4
                               #      | _Z_call_165:
                               #      | _A_if_150:
ec ff 00 f8 0e 00              # e856 |   jne H, 0, ${_E_if_150}:rel + PC
60 ff 1c 09                    # e85c |   mov H, 0x9
58 f8 03 01                    # e860 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_150:
                               #      | _C_if_150:
                               #      | _Z_if_150:
                               #      | _A_call_166:
e0 e0 72 f0                    # e864 |   push ${const__str__INIT_OLED}
e0 20                          # e868 |   push A
5c f8 87 eb                    # e86a |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e86e |   mov SP, SP + 0x4
                               #      | _Z_call_166:
                               #      | _A_if_152:
ec ff 00 f8 0e 00              # e872 |   jne H, 0, ${_E_if_152}:rel + PC
60 ff 1c 0a                    # e878 |   mov H, 0xa
58 f8 e7 00                    # e87c |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_152:
                               #      | _C_if_152:
                               #      | _Z_if_152:
                               #      | _A_call_167:
e0 e0 7c f0                    # e880 |   push ${const__str__READW}
e0 20                          # e884 |   push A
5c f8 6b eb                    # e886 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e88a |   mov SP, SP + 0x4
                               #      | _Z_call_167:
                               #      | _A_if_154:
ec ff 00 f8 0e 00              # e88e |   jne H, 0, ${_E_if_154}:rel + PC
60 ff 1c 0b                    # e894 |   mov H, 0xb
58 f8 cb 00                    # e898 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_154:
                               #      | _C_if_154:
                               #      | _Z_if_154:
                               #      | _A_call_168:
e0 e0 82 f0                    # e89c |   push ${const__str__DEINIT_OLED}
e0 20                          # e8a0 |   push A
5c f8 4f eb                    # e8a2 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e8a6 |   mov SP, SP + 0x4
                               #      | _Z_call_168:
                               #      | _A_if_156:
ec ff 00 f8 0e 00              # e8aa |   jne H, 0, ${_E_if_156}:rel + PC
60 ff 1c 0c                    # e8b0 |   mov H, 0xc
58 f8 af 00                    # e8b4 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_156:
                               #      | _C_if_156:
                               #      | _Z_if_156:
                               #      | _A_call_169:
e0 e0 8e f0                    # e8b8 |   push ${const__str__WRITE_SD}
e0 20                          # e8bc |   push A
5c f8 33 eb                    # e8be |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e8c2 |   mov SP, SP + 0x4
                               #      | _Z_call_169:
                               #      | _A_if_158:
ec ff 00 f8 0e 00              # e8c6 |   jne H, 0, ${_E_if_158}:rel + PC
60 ff 1c 0d                    # e8cc |   mov H, 0xd
58 f8 93 00                    # e8d0 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_158:
                               #      | _C_if_158:
                               #      | _Z_if_158:
                               #      | _A_call_170:
e0 e0 97 f0                    # e8d4 |   push ${const__str__MMAP}
e0 20                          # e8d8 |   push A
5c f8 17 eb                    # e8da |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e8de |   mov SP, SP + 0x4
                               #      | _Z_call_170:
                               #      | _A_if_160:
ec ff 00 f8 0e 00              # e8e2 |   jne H, 0, ${_E_if_160}:rel + PC
60 ff 1c 0e                    # e8e8 |   mov H, 0xe
58 f8 77 00                    # e8ec |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_160:
                               #      | _C_if_160:
                               #      | _Z_if_160:
                               #      | _A_call_171:
e0 e0 9c f0                    # e8f0 |   push ${const__str__UMAP}
e0 20                          # e8f4 |   push A
5c f8 fb ea                    # e8f6 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e8fa |   mov SP, SP + 0x4
                               #      | _Z_call_171:
                               #      | _A_if_162:
ec ff 00 f8 0e 00              # e8fe |   jne H, 0, ${_E_if_162}:rel + PC
60 ff 1c 0f                    # e904 |   mov H, 0xf
58 f8 5b 00                    # e908 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_162:
                               #      | _C_if_162:
                               #      | _Z_if_162:
                               #      | _A_call_172:
e0 e0 a1 f0                    # e90c |   push ${const__str__WRITEB_SD}
e0 20                          # e910 |   push A
5c f8 df ea                    # e912 |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e916 |   mov SP, SP + 0x4
                               #      | _Z_call_172:
                               #      | _A_if_164:
ec ff 00 f8 0e 00              # e91a |   jne H, 0, ${_E_if_164}:rel + PC
60 ff 1c 10                    # e920 |   mov H, 0x10
58 f8 3f 00                    # e924 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_164:
                               #      | _C_if_164:
                               #      | _Z_if_164:
                               #      | _A_call_173:
e0 e0 ab f0                    # e928 |   push ${const__str__SHOW_IMG}
e0 20                          # e92c |   push A
5c f8 c3 ea                    # e92e |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e932 |   mov SP, SP + 0x4
                               #      | _Z_call_173:
                               #      | _A_if_166:
ec ff 00 f8 0e 00              # e936 |   jne H, 0, ${_E_if_166}:rel + PC
60 ff 1c 11                    # e93c |   mov H, 0x11
58 f8 23 00                    # e940 |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_166:
                               #      | _C_if_166:
                               #      | _Z_if_166:
                               #      | _A_call_174:
e0 e0 b4 f0                    # e944 |   push ${const__str__ERASE_SD}
e0 20                          # e948 |   push A
5c f8 a7 ea                    # e94a |   call ${fn_strcasecmp}:rel + PC
60 a0 bc 04                    # e94e |   mov SP, SP + 0x4
                               #      | _Z_call_174:
                               #      | _A_if_168:
ec ff 00 f8 0e 00              # e952 |   jne H, 0, ${_E_if_168}:rel + PC
60 ff 1c 12                    # e958 |   mov H, 0x12
58 f8 07 00                    # e95c |   jmp ${_cleanup_fn_parse_command_name}:rel + PC
                               #      | _E_if_168:
                               #      | _C_if_168:
                               #      | _Z_if_168:
60 ff 00                       # e960 |   mov H, 0
