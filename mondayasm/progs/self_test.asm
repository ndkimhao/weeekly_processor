...
b6 e0 1c fe 39 30 85           # d5f9 |   xor [0x3039], 0x-7b, G
ee e0 e0 e0 39 30 d0 fe 0d d0  # d600 |   jne [0x3039], 0xfed0, $fail
ae 3e fe 21 f6                 # d60a |   and [A*4 + 0x-a], G, A*2
ee e0 e0 e0 9e 02 54 01 0d d0  # d60f |   jne [0x29e], 0x154, $fail
86 21 e4 3e de fa f6           # d619 |   sub [A*2], 0xfade + A, A*4 + 0x-a
...
82 20 3e 3e f6 f6              # d70c |   add [A], A*4 + 0x-a, A*4 + 0x-a
ee e0 e0 e0 aa 00 3c 05 0d d0  # d712 |   jne [0xaa], 0x53c, $fail
b2 e0 21 1c 39 30 85           # d71c |   or [0x3039], A*2, 0x-7b
...
8e e0 2a 3e 39 30 f6           # d74f |   imul [0x3039], A*4 + B, A*4 + 0x-a
...
8e 21 3e 21 f6                 # d770 |   imul [A*2], A*4 + 0x-a, A*2
ee e0 e0 e0 54 01 d8 79 0d d0  # d775 |   jne [0x154], 0x79d8, $fail
82 3e 1c 2a f6 85              # d77f |   add [A*4 + 0x-a], 0x-7b, A*4 + B
...
82 3e 3e 20 f6 f6              # d7c9 |   add [A*4 + 0x-a], A*4 + 0x-a, A
...
a2 20 1c fe 85                 # d7e9 |   shr [A], 0x-7b, G
ee e0 e0 e0 aa 00 fc 07 0d d0  # d7ee |   jne [0xaa], 0x7fc, $fail
aa 2a 1c 2a 85                 # d7f8 |   shl [A*4 + B], 0x-7b, A*4 + B
...
86 20 20 1c 85                 # d815 |   sub [A], A, 0x-7b
ee e0 e0 e0 aa 00 25 01 0d d0  # d81a |   jne [0xaa], 0x125, $fail
a6 3e e4 21 f6 de fa           # d824 |   ishr [A*4 + 0x-a], 0xfade + A, A*2
...
a2 2a 2a 1c 85                 # d887 |   shr [A*4 + B], A*4 + B, 0x-7b
...
8a 20 fe 3e f6                 # d8c4 |   mul [A], G, A*4 + 0x-a
...
8e fe 3e 2a f6                 # d8e3 |   imul [G], A*4 + 0x-a, A*4 + B
...
82 fe 1c 20 85                 # d92d |   add [G], 0x-7b, A
ee e0 1c e0 55 01 2f 0d d0     # d932 |   jne [0x155], 0x2f, $fail
8e 3e fe e0 f6 39 30           # d93b |   imul [A*4 + 0x-a], G, 0x3039
...
b2 3e 1c 21 f6 85              # d976 |   or [A*4 + 0x-a], 0x-7b, A*2
ee e0 e0 e0 9e 02 d5 ff 0d d0  # d97c |   jne [0x29e], 0xffd5, $fail
8a 2a 1c 1c 85 85              # d986 |   mul [A*4 + B], 0x-7b, 0x-7b
...
86 fe 20 3e f6                 # d9a8 |   sub [G], A, A*4 + 0x-a
...
b6 21 1c 2a 85                 # d9c5 |   xor [A*2], 0x-7b, A*4 + B
ee e0 e0 e0 54 01 e6 fc 0d d0  # d9ca |   jne [0x154], 0xfce6, $fail
86 2a 3e 1c f6 85              # d9d4 |   sub [A*4 + B], A*4 + 0x-a, 0x-7b
...
aa 20 3e fe f6                 # da08 |   shl [A], A*4 + 0x-a, G
...
a6 21 21 1c 85                 # da35 |   ishr [A*2], A*2, 0x-7b
...
86 2a 3e 2a f6                 # da53 |   sub [A*4 + B], A*4 + 0x-a, A*4 + B
ee e0 e0 e0 63 03 3b ff 0d d0  # da58 |   jne [0x363], 0xff3b, $fail
b2 e0 fe 1c 39 30 85           # da62 |   or [0x3039], G, 0x-7b
ee e0 e0 e0 39 30 d5 ff 0d d0  # da69 |   jne [0x3039], 0xffd5, $fail
aa 2a 3e 20 f6                 # da73 |   shl [A*4 + B], A*4 + 0x-a, A
...
ae 2a e0 1c 39 30 85           # daa2 |   and [A*4 + B], 0x3039, 0x-7b
...
a6 3e e0 20 f6 39 30           # dad1 |   ishr [A*4 + 0x-a], 0x3039, A
...
b6 fe 3e 21 f6                 # db05 |   xor [G], A*4 + 0x-a, A*2
ee e0 e0 e0 55 01 ca 03 0d d0  # db0a |   jne [0x155], 0x3ca, $fail
b2 2a fe 1c 85                 # db14 |   or [A*4 + B], G, 0x-7b
ee e0 e0 e0 63 03 d5 ff 0d d0  # db19 |   jne [0x363], 0xffd5, $fail
86 3e 1c e0 f6 85 39 30        # db23 |   sub [A*4 + 0x-a], 0x-7b, 0x3039
...
a2 21 e0 1c 39 30 85           # db57 |   shr [A*2], 0x3039, 0x-7b
...
b6 3e e4 e0 f6 de fa 39 30     # db7a |   xor [A*4 + 0x-a], 0xfade + A, 0x3039
ee e0 e0 e0 9e 02 b1 cb 0d d0  # db83 |   jne [0x29e], 0xcbb1, $fail
86 3e 21 3e f6 f6              # db8d |   sub [A*4 + 0x-a], A*2, A*4 + 0x-a
ee e0 e0 e0 9e 02 b6 fe 0d d0  # db93 |   jne [0x29e], 0xfeb6, $fail
8e fe 1c 3e 85 f6              # db9d |   imul [G], 0x-7b, A*4 + 0x-a
...
b6 fe 21 1c 85                 # dc04 |   xor [G], A*2, 0x-7b
...
b2 3e e0 2a f6 39 30           # dc23 |   or [A*4 + 0x-a], 0x3039, A*4 + B
ee e0 e0 e0 9e 02 7b 33 0d d0  # dc2a |   jne [0x29e], 0x337b, $fail
b6 fe e4 3e de fa f6           # dc34 |   xor [G], 0xfade + A, A*4 + 0x-a
...
8a 21 1c 1c 85 85              # dc60 |   mul [A*2], 0x-7b, 0x-7b
...
a2 3e 3e 3e f6 f6 f6           # dc80 |   shr [A*4 + 0x-a], A*4 + 0x-a, A*4 + 0x-a
ee e0 00 e0 9e 02 0d d0        # dc87 |   jne [0x29e], 0, $fail
8a 20 1c e4 85 de fa           # dc8f |   mul [A], 0x-7b, 0xfade + A
ee e0 e0 e0 aa 00 a8 25 0d d0  # dc96 |   jne [0xaa], 0x25a8, $fail
a6 3e 20 21 f6                 # dca0 |   ishr [A*4 + 0x-a], A, A*2
ee e0 1c e0 9e 02 0a 0d d0     # dca5 |   jne [0x29e], 0xa, $fail
b2 3e 20 20 f6                 # dcae |   or [A*4 + 0x-a], A, A
...
8e 3e e0 3e f6 39 30 f6        # dccf |   imul [A*4 + 0x-a], 0x3039, A*4 + 0x-a
...
8e 20 e4 3e de fa f6           # dcee |   imul [A], 0xfade + A, A*4 + 0x-a
...
82 2a e0 3e 39 30 f6           # dd0c |   add [A*4 + B], 0x3039, A*4 + 0x-a
ee e0 e0 e0 63 03 d7 32 0d d0  # dd13 |   jne [0x363], 0x32d7, $fail
ae 3e 2a e4 f6 de fa           # dd1d |   and [A*4 + 0x-a], A*4 + B, 0xfade + A
ee e0 e0 e0 9e 02 00 03 0d d0  # dd24 |   jne [0x29e], 0x300, $fail
8e 20 1c 2a 85                 # dd2e |   imul [A], 0x-7b, A*4 + B
ee e0 e0 e0 aa 00 6f 5f 0d d0  # dd33 |   jne [0xaa], 0x5f6f, $fail
a2 fe 3e e4 f6 de fa           # dd3d |   shr [G], A*4 + 0x-a, 0xfade + A
...
b2 21 2a 3e f6                 # dd7d |   or [A*2], A*4 + B, A*4 + 0x-a
...
aa 3e e4 1c f6 de fa 85        # ddae |   shl [A*4 + 0x-a], 0xfade + A, 0x-7b
ee e0 e0 e0 9e 02 00 71 0d d0  # ddb6 |   jne [0x29e], 0x7100, $fail
a2 3e e4 20 f6 de fa           # ddc0 |   shr [A*4 + 0x-a], 0xfade + A, A
ee e0 1c e0 9e 02 3e 0d d0     # ddc7 |   jne [0x29e], 0x3e, $fail
8a 3e 20 2a f6                 # ddd0 |   mul [A*4 + 0x-a], A, A*4 + B
ee e0 e0 e0 9e 02 be 3f 0d d0  # ddd5 |   jne [0x29e], 0x3fbe, $fail
b2 21 3e 2a f6                 # dddf |   or [A*2], A*4 + 0x-a, A*4 + B
ee e0 e0 e0 54 01 ff 03 0d d0  # dde4 |   jne [0x154], 0x3ff, $fail
8e 3e 21 1c f6 85              # ddee |   imul [A*4 + 0x-a], A*2, 0x-7b
ee e0 e0 e0 9e 02 a4 5c 0d d0  # ddf4 |   jne [0x29e], 0x5ca4, $fail
aa e0 3e 21 39 30 f6           # ddfe |   shl [0x3039], A*4 + 0x-a, A*2
...
ae 3e e0 e0 f6 39 30 39 30     # de3f |   and [A*4 + 0x-a], 0x3039, 0x3039
ee e0 e0 e0 9e 02 39 30 0d d0  # de48 |   jne [0x29e], 0x3039, $fail
aa 3e 20 1c f6 85              # de52 |   shl [A*4 + 0x-a], A, 0x-7b
ee e0 e0 e0 9e 02 40 15 0d d0  # de58 |   jne [0x29e], 0x1540, $fail
ae 2a 3e e4 f6 de fa           # de62 |   and [A*4 + B], A*4 + 0x-a, 0xfade + A
ee e0 e0 e0 63 03 88 02 0d d0  # de69 |   jne [0x363], 0x288, $fail
82 fe 1c 1c 85 85              # de73 |   add [G], 0x-7b, 0x-7b
...
b6 fe e0 1c 39 30 85           # df1a |   xor [G], 0x3039, 0x-7b
...
8e 3e 21 21 f6                 # df96 |   imul [A*4 + 0x-a], A*2, A*2
ee e0 e0 e0 9e 02 90 c3 0d d0  # df9b |   jne [0x29e], 0xc390, $fail
b2 fe e4 1c de fa 85           # dfa5 |   or [G], 0xfade + A, 0x-7b
ee e0 e0 e0 55 01 8d ff 0d d0  # dfac |   jne [0x155], 0xff8d, $fail
8e 2a 20 3e f6                 # dfb6 |   imul [A*4 + B], A, A*4 + 0x-a
ee e0 e0 e0 63 03 ec bc 0d d0  # dfbb |   jne [0x363], 0xbcec, $fail
a2 2a 3e e0 f6 39 30           # dfc5 |   shr [A*4 + B], A*4 + 0x-a, 0x3039
...
a2 e0 3e e0 39 30 f6 39 30     # dfe5 |   shr [0x3039], A*4 + 0x-a, 0x3039
ee e0 1c e0 39 30 01 0d d0     # dfee |   jne [0x3039], 0x1, $fail
a2 21 1c 3e 85 f6              # dff7 |   shr [A*2], 0x-7b, A*4 + 0x-a
...
b6 e0 3e 2a 39 30 f6           # e021 |   xor [0x3039], A*4 + 0x-a, A*4 + B
ee e0 e0 e0 39 30 fd 01 0d d0  # e028 |   jne [0x3039], 0x1fd, $fail
8a 3e e4 3e f6 de fa f6        # e032 |   mul [A*4 + 0x-a], 0xfade + A, A*4 + 0x-a
ee e0 e0 e0 9e 02 f0 4d 0d d0  # e03a |   jne [0x29e], 0x4df0, $fail
8e 2a 21 3e f6                 # e044 |   imul [A*4 + B], A*2, A*4 + 0x-a
ee e0 e0 e0 63 03 d8 79 0d d0  # e049 |   jne [0x363], 0x79d8, $fail
a2 e0 e4 3e 39 30 de fa f6     # e053 |   shr [0x3039], 0xfade + A, A*4 + 0x-a
ee e0 1c e0 39 30 03 0d d0     # e05c |   jne [0x3039], 0x3, $fail
82 3e 20 fe f6                 # e065 |   add [A*4 + 0x-a], A, G
...
a2 3e 1c 1c f6 85 85           # e085 |   shr [A*4 + 0x-a], 0x-7b, 0x-7b
ee e0 e0 e0 9e 02 fc 07 0d d0  # e08c |   jne [0x29e], 0x7fc, $fail
8e 20 1c e0 85 39 30           # e096 |   imul [A], 0x-7b, 0x3039
ee e0 e0 e0 aa 00 9d d4 0d d0  # e09d |   jne [0xaa], 0xd49d, $fail
aa 2a 3e 21 f6                 # e0a7 |   shl [A*4 + B], A*4 + 0x-a, A*2
...
b6 e0 3e 3e 39 30 f6 f6        # e0c6 |   xor [0x3039], A*4 + 0x-a, A*4 + 0x-a
ee e0 00 e0 39 30 0d d0        # e0ce |   jne [0x3039], 0, $fail
b6 20 21 1c 85                 # e0d6 |   xor [A], A*2, 0x-7b
...
ae 3e e0 1c f6 39 30 85        # e122 |   and [A*4 + 0x-a], 0x3039, 0x-7b
...
aa e0 fe 3e 39 30 f6           # e1e2 |   shl [0x3039], G, A*4 + 0x-a
ee e0 e0 e0 39 30 00 40 0d d0  # e1e9 |   jne [0x3039], 0x4000, $fail
ae 20 1c 1c 85 85              # e1f3 |   and [A], 0x-7b, 0x-7b
...
b2 e0 21 3e 39 30 f6           # e213 |   or [0x3039], A*2, A*4 + 0x-a
...
b6 fe 3e 3e f6 f6              # e234 |   xor [G], A*4 + 0x-a, A*4 + 0x-a
ee e0 00 e0 55 01 0d d0        # e23a |   jne [0x155], 0, $fail
b6 3e 20 e4 f6 de fa           # e242 |   xor [A*4 + 0x-a], A, 0xfade + A
ee e0 e0 e0 9e 02 22 fb 0d d0  # e249 |   jne [0x29e], 0xfb22, $fail
b6 e0 1c e0 39 30 85 39 30     # e253 |   xor [0x3039], 0x-7b, 0x3039
ee e0 e0 e0 39 30 bc cf 0d d0  # e25c |   jne [0x3039], 0xcfbc, $fail
a2 3e fe 2a f6                 # e266 |   shr [A*4 + 0x-a], G, A*4 + B
...
86 2a e4 1c de fa 85           # e280 |   sub [A*4 + B], 0xfade + A, 0x-7b
...
8e 3e 2a 3e f6 f6              # e2b1 |   imul [A*4 + 0x-a], A*4 + B, A*4 + 0x-a
ee e0 e0 e0 9e 02 1a dd 0d d0  # e2b7 |   jne [0x29e], 0xdd1a, $fail
a2 e0 3e 1c 39 30 f6 85        # e2c1 |   shr [0x3039], A*4 + 0x-a, 0x-7b
...
a6 e0 e4 1c 39 30 de fa 85     # e2f2 |   ishr [0x3039], 0xfade + A, 0x-7b
ee e0 e0 e0 39 30 dc ff 0d d0  # e2fb |   jne [0x3039], 0xffdc, $fail
b2 3e fe 20 f6                 # e305 |   or [A*4 + 0x-a], G, A
...
8a 21 3e 20 f6                 # e330 |   mul [A*2], A*4 + 0x-a, A
ee e0 e0 e0 54 01 ec bc 0d d0  # e335 |   jne [0x154], 0xbcec, $fail
8e 3e 3e e0 f6 f6 39 30        # e33f |   imul [A*4 + 0x-a], A*4 + 0x-a, 0x3039
ee e0 e0 e0 9e 02 2e 35 0d d0  # e347 |   jne [0x29e], 0x352e, $fail
b6 e0 1c 3e 39 30 85 f6        # e351 |   xor [0x3039], 0x-7b, A*4 + 0x-a
...
8e fe fe 3e f6                 # e373 |   imul [G], G, A*4 + 0x-a
ee e0 e0 e0 55 01 76 7c 0d d0  # e378 |   jne [0x155], 0x7c76, $fail
8a 20 e0 3e 39 30 f6           # e382 |   mul [A], 0x3039, A*4 + 0x-a
...
a2 3e 21 e4 f6 de fa           # e3a1 |   shr [A*4 + 0x-a], A*2, 0xfade + A
ee e0 1c e0 9e 02 01 0d d0     # e3a8 |   jne [0x29e], 0x1, $fail
a6 20 3e 2a f6                 # e3b1 |   ishr [A], A*4 + 0x-a, A*4 + B
...
a6 20 1c 20 85                 # e3cf |   ishr [A], 0x-7b, A
ee e0 e0 e0 aa 00 ff ff 0d d0  # e3d4 |   jne [0xaa], 0xffff, $fail
ae 21 20 1c 85                 # e3de |   and [A*2], A, 0x-7b
ee e0 e0 e0 54 01 80 00 0d d0  # e3e3 |   jne [0x154], 0x80, $fail
b6 2a 1c e4 85 de fa           # e3ed |   xor [A*4 + B], 0x-7b, 0xfade + A
...
86 20 fe 1c 85                 # e4a5 |   sub [A], G, 0x-7b
ee e0 e0 e0 aa 00 d0 01 0d d0  # e4aa |   jne [0xaa], 0x1d0, $fail
b2 20 2a 3e f6                 # e4b4 |   or [A], A*4 + B, A*4 + 0x-a
...
aa 21 fe 3e f6                 # e4d1 |   shl [A*2], G, A*4 + 0x-a
ee e0 e0 e0 54 01 00 40 0d d0  # e4d6 |   jne [0x154], 0x4000, $fail
ae 3e e0 21 f6 39 30           # e4e0 |   and [A*4 + 0x-a], 0x3039, A*2
...
a2 3e 3e fe f6 f6              # e50f |   shr [A*4 + 0x-a], A*4 + 0x-a, G
...
8a 2a 1c 3e 85 f6              # e530 |   mul [A*4 + B], 0x-7b, A*4 + 0x-a
ee e0 e0 e0 63 03 16 be 0d d0  # e536 |   jne [0x363], 0xbe16, $fail
ae 2a 1c fe 85                 # e540 |   and [A*4 + B], 0x-7b, G
...
86 3e 1c 3e f6 85 f6           # e56f |   sub [A*4 + 0x-a], 0x-7b, A*4 + 0x-a
...
82 20 3e 21 f6                 # e58e |   add [A], A*4 + 0x-a, A*2
ee e0 e0 e0 aa 00 f2 03 0d d0  # e593 |   jne [0xaa], 0x3f2, $fail
8a 21 fe 1c 85                 # e59d |   mul [A*2], G, 0x-7b
ee e0 e0 e0 54 01 29 5c 0d d0  # e5a2 |   jne [0x154], 0x5c29, $fail
8a fe 1c e0 85 39 30           # e5ac |   mul [G], 0x-7b, 0x3039
...
82 2a 1c 21 85                 # e5cc |   add [A*4 + B], 0x-7b, A*2
...
aa 2a 1c e0 85 39 30           # e5fd |   shl [A*4 + B], 0x-7b, 0x3039
ee e0 e0 e0 63 03 00 0a 0d d0  # e604 |   jne [0x363], 0xa00, $fail
8a fe 1c 2a 85                 # e60e |   mul [G], 0x-7b, A*4 + B
ee e0 e0 e0 55 01 6f 5f 0d d0  # e613 |   jne [0x155], 0x5f6f, $fail
ae 3e e0 fe f6 39 30           # e61d |   and [A*4 + 0x-a], 0x3039, G
...
aa 2a 3e 3e f6 f6              # e658 |   shl [A*4 + B], A*4 + 0x-a, A*4 + 0x-a
ee e0 e0 e0 63 03 00 80 0d d0  # e65e |   jne [0x363], 0x8000, $fail
86 3e 2a 1c f6 85              # e668 |   sub [A*4 + 0x-a], A*4 + B, 0x-7b
ee e0 e0 e0 9e 02 de 03 0d d0  # e66e |   jne [0x29e], 0x3de, $fail
ae fe fe 1c 85                 # e678 |   and [G], G, 0x-7b
ee e0 e0 e0 55 01 05 01 0d d0  # e67d |   jne [0x155], 0x105, $fail
a6 21 3e 1c f6 85              # e687 |   ishr [A*2], A*4 + 0x-a, 0x-7b
...
8e 3e 3e e4 f6 f6 de fa        # e6c2 |   imul [A*4 + 0x-a], A*4 + 0x-a, 0xfade + A
ee e0 e0 e0 9e 02 f0 4d 0d d0  # e6ca |   jne [0x29e], 0x4df0, $fail
a2 2a 3e fe f6                 # e6d4 |   shr [A*4 + B], A*4 + 0x-a, G
ee e0 1c e0 63 03 14 0d d0     # e6d9 |   jne [0x363], 0x14, $fail
aa e0 2a 1c 39 30 85           # e6e2 |   shl [0x3039], A*4 + B, 0x-7b
ee e0 e0 e0 39 30 60 6c 0d d0  # e6e9 |   jne [0x3039], 0x6c60, $fail
86 e0 3e 20 39 30 f6           # e6f3 |   sub [0x3039], A*4 + 0x-a, A
ee e0 e0 e0 39 30 f4 01 0d d0  # e6fa |   jne [0x3039], 0x1f4, $fail
86 fe 3e fe f6                 # e704 |   sub [G], A*4 + 0x-a, G
...
aa 2a 2a 3e f6                 # e74c |   shl [A*4 + B], A*4 + B, A*4 + 0x-a
ee e0 e0 e0 63 03 00 c0 0d d0  # e751 |   jne [0x363], 0xc000, $fail
b6 3e 2a 20 f6                 # e75b |   xor [A*4 + 0x-a], A*4 + B, A
ee e0 e0 e0 9e 02 c9 03 0d d0  # e760 |   jne [0x29e], 0x3c9, $fail
8a 20 e4 1c de fa 85           # e76a |   mul [A], 0xfade + A, 0x-7b
ee e0 e0 e0 aa 00 a8 25 0d d0  # e771 |   jne [0xaa], 0x25a8, $fail
ae 3e e0 e4 f6 39 30 de fa     # e77b |   and [A*4 + 0x-a], 0x3039, 0xfade + A
...
a2 e0 3e e4 39 30 f6 de fa     # e7ac |   shr [0x3039], A*4 + 0x-a, 0xfade + A
ee e0 1c e0 39 30 02 0d d0     # e7b5 |   jne [0x3039], 0x2, $fail
a2 3e 21 2a f6                 # e7be |   shr [A*4 + 0x-a], A*2, A*4 + B
...
8a 3e e4 e4 f6 de fa de fa     # e7e7 |   mul [A*4 + 0x-a], 0xfade + A, 0xfade + A
ee e0 e0 e0 9e 02 40 f8 0d d0  # e7f0 |   jne [0x29e], 0xf840, $fail
82 3e 2a e0 f6 39 30           # e7fa |   add [A*4 + 0x-a], A*4 + B, 0x3039
ee e0 e0 e0 9e 02 9c 33 0d d0  # e801 |   jne [0x29e], 0x339c, $fail
b6 2a fe 3e f6                 # e80b |   xor [A*4 + B], G, A*4 + 0x-a
...
b6 e0 1c 21 39 30 85           # e84c |   xor [0x3039], 0x-7b, A*2
...
8a 21 3e e0 f6 39 30           # e87f |   mul [A*2], A*4 + 0x-a, 0x3039
...
ae fe 1c e4 85 de fa           # e89e |   and [G], 0x-7b, 0xfade + A
...
b6 3e 20 3e f6 f6              # e8bc |   xor [A*4 + 0x-a], A, A*4 + 0x-a
ee e0 e0 e0 9e 02 34 02 0d d0  # e8c2 |   jne [0x29e], 0x234, $fail
aa 3e 3e 21 f6 f6              # e8cc |   shl [A*4 + 0x-a], A*4 + 0x-a, A*2
ee e0 e0 e0 9e 02 e0 29 0d d0  # e8d2 |   jne [0x29e], 0x29e0, $fail
8a 20 3e 1c f6 85              # e8dc |   mul [A], A*4 + 0x-a, 0x-7b
...
a2 2a e4 3e de fa f6           # e8fc |   shr [A*4 + B], 0xfade + A, A*4 + 0x-a
...
ae 3e 21 e0 f6 39 30           # e91c |   and [A*4 + 0x-a], A*2, 0x3039
...
b2 3e fe fe f6                 # e966 |   or [A*4 + 0x-a], G, G
...
a2 fe 3e 1c f6 85              # e983 |   shr [G], A*4 + 0x-a, 0x-7b
...
8a 21 1c e4 85 de fa           # e9a0 |   mul [A*2], 0x-7b, 0xfade + A
...
8e fe 3e e0 f6 39 30           # ea42 |   imul [G], A*4 + 0x-a, 0x3039
ee e0 e0 e0 55 01 2e 35 0d d0  # ea49 |   jne [0x155], 0x352e, $fail
82 e0 1c 1c 39 30 85 85        # ea53 |   add [0x3039], 0x-7b, 0x-7b
ee e0 e0 e0 39 30 0a ff 0d d0  # ea5b |   jne [0x3039], 0xff0a, $fail
86 21 3e fe f6                 # ea65 |   sub [A*2], A*4 + 0x-a, G
...
a2 e0 1c 20 39 30 85           # eb26 |   shr [0x3039], 0x-7b, A
ee e0 1c e0 39 30 3f 0d d0     # eb2d |   jne [0x3039], 0x3f, $fail
8e 20 20 3e f6                 # eb36 |   imul [A], A, A*4 + 0x-a
...
b6 fe e0 3e 39 30 f6           # eb55 |   xor [G], 0x3039, A*4 + 0x-a
...
b2 3e e4 fe f6 de fa           # eb76 |   or [A*4 + 0x-a], 0xfade + A, G
ee e0 e0 e0 9e 02 dd fb 0d d0  # eb7d |   jne [0x29e], 0xfbdd, $fail
86 21 1c 21 85                 # eb87 |   sub [A*2], 0x-7b, A*2
...
8e e0 20 3e 39 30 f6           # eba4 |   imul [0x3039], A, A*4 + 0x-a
ee e0 e0 e0 39 30 ec bc 0d d0  # ebab |   jne [0x3039], 0xbcec, $fail
a6 3e e4 2a f6 de fa           # ebb5 |   ishr [A*4 + 0x-a], 0xfade + A, A*4 + B
...
8e 20 3e 20 f6                 # ebe5 |   imul [A], A*4 + 0x-a, A
ee e0 e0 e0 aa 00 ec bc 0d d0  # ebea |   jne [0xaa], 0xbcec, $fail
b2 e0 3e fe 39 30 f6           # ebf4 |   or [0x3039], A*4 + 0x-a, G
...
82 e0 1c e4 39 30 85 de fa     # ec17 |   add [0x3039], 0x-7b, 0xfade + A
...
ae 2a 20 1c 85                 # ec58 |   and [A*4 + B], A, 0x-7b
ee e0 e0 e0 63 03 80 00 0d d0  # ec5d |   jne [0x363], 0x80, $fail
b6 e0 20 1c 39 30 85           # ec67 |   xor [0x3039], A, 0x-7b
...
ae 3e fe 3e f6 f6              # ec87 |   and [A*4 + 0x-a], G, A*4 + 0x-a
ee e0 1c e0 9e 02 14 0d d0     # ec8d |   jne [0x29e], 0x14, $fail
8a 3e 2a 2a f6                 # ec96 |   mul [A*4 + 0x-a], A*4 + B, A*4 + B
ee e0 e0 e0 9e 02 49 78 0d d0  # ec9b |   jne [0x29e], 0x7849, $fail
82 20 3e e0 f6 39 30           # eca5 |   add [A], A*4 + 0x-a, 0x3039
ee e0 e0 e0 aa 00 d7 32 0d d0  # ecac |   jne [0xaa], 0x32d7, $fail
82 21 e0 3e 39 30 f6           # ecb6 |   add [A*2], 0x3039, A*4 + 0x-a
ee e0 e0 e0 54 01 d7 32 0d d0  # ecbd |   jne [0x154], 0x32d7, $fail
b6 21 3e 3e f6 f6              # ecc7 |   xor [A*2], A*4 + 0x-a, A*4 + 0x-a
...
a6 e0 e0 3e 39 30 39 30 f6     # ece3 |   ishr [0x3039], 0x3039, A*4 + 0x-a
ee e0 00 e0 39 30 0d d0        # ecec |   jne [0x3039], 0, $fail
aa 20 1c 21 85                 # ecf4 |   shl [A], 0x-7b, A*2
...
b2 3e 1c 20 f6 85              # ed15 |   or [A*4 + 0x-a], 0x-7b, A
ee e0 e0 e0 9e 02 af ff 0d d0  # ed1b |   jne [0x29e], 0xffaf, $fail
8e 21 1c 20 85                 # ed25 |   imul [A*2], 0x-7b, A
...
ae fe 1c 21 85                 # ed52 |   and [G], 0x-7b, A*2
ee e0 e0 e0 55 01 04 01 0d d0  # ed57 |   jne [0x155], 0x104, $fail
8e 21 e4 1c de fa 85           # ed61 |   imul [A*2], 0xfade + A, 0x-7b
...
62 20 1c 85                    # ed92 |   mov [A], 0x-7b
ee e0 e0 e0 aa 00 85 ff 0d d0  # ed96 |   jne [0xaa], 0xff85, $fail
62 3e 3e f6 f6                 # eda0 |   mov [A*4 + 0x-a], A*4 + 0x-a
...
62 e0 1c 39 30 85              # edbc |   mov [0x3039], 0x-7b
ee e0 e0 e0 39 30 85 ff 0d d0  # edc2 |   jne [0x3039], 0xff85, $fail
62 fe 3e f6                    # edcc |   mov [G], A*4 + 0x-a
...
62 3e e4 f6 de fa              # edf6 |   mov [A*4 + 0x-a], 0xfade + A
...
62 3e fe f6                    # ee17 |   mov [A*4 + 0x-a], G
...
62 3e 2a f6                    # ee3f |   mov [A*4 + 0x-a], A*4 + B
...
62 3e 20 f6                    # ee5a |   mov [A*4 + 0x-a], A
...
62 21 1c 85                    # ee84 |   mov [A*2], 0x-7b
...
62 3e e0 f6 39 30              # ef98 |   mov [A*4 + 0x-a], 0x3039
...
62 2a 1c 85                    # efdc |   mov [A*4 + B], 0x-7b
...
ec 20 1c e0 0e 0d d0           # f26a |   jne A, 0xe, $fail
                               #      | test_uop_cmp_di:
62 1c 1c 64 85                 # f271 |   mov [0x64], 0x-7b
...
ec 20 1c e0 32 0d d0           # f289 |   jne A, 0x32, $fail
                               #      | test_uop_cmp_id:
62 1c 1c 64 85                 # f290 |   mov [0x64], 0x-7b
...
ec 20 1c e0 0e 0d d0           # f2a8 |   jne A, 0xe, $fail
                               #      | test_uop_cmp_ii:
62 1c 1c 64 85                 # f2af |   mov [0x64], 0x-7b
62 1c e0 66 38 fe              # f2b4 |   mov [0x66], 0x-1c8
d3 1c 1c 64 66                 # f2ba |   icmp [0x64], [0x66]
4c 20                          # f2bf |   getf A
ee 1c 1c e0 64 85 0d d0        # f2c1 |   jne [0x64], 0x-7b, $fail
ee 1c e0 e0 66 38 fe 0d d0     # f2c9 |   jne [0x66], 0x-1c8, $fail
