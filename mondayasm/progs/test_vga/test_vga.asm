...
60 20 00                       # a5b1 |   mov A, 0
                               #      | _B_fn_start_2:
e8 20 1c f8 ff 10 00           # a5b4 |   jeq A, 0xff, ${_E_fn_start_2}:rel + PC
44 20                          # a5bb |   inc A
08 40 40                       # a5bd |   mul B, B
58 f8 f4 ff                    # a5c0 |   jmp ${_B_fn_start_2}:rel + PC
                               #      | _E_fn_start_2:
46 e0 0a ff                    # a5c4 |   inc [0xff0a]
44 fc                          # a5c8 |   inc E
62 e0 fc 00 10                 # a5ca |   mov [0x1000], E
62 e0 fc b0 0f                 # a5cf |   mov [0xfb0], E
62 e0 fc 60 0f                 # a5d4 |   mov [0xf60], E
62 e0 fc 10 0f                 # a5d9 |   mov [0xf10], E
62 e0 fc c0 0e                 # a5de |   mov [0xec0], E
62 e0 fc 70 0e                 # a5e3 |   mov [0xe70], E
62 e0 fc 20 0e                 # a5e8 |   mov [0xe20], E
