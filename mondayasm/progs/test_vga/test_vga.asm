...
60 20 00                       # aa11 |   mov A, 0
                               #      | _B_fn_start_2:
e8 20 1c f8 ff 11 00           # aa14 |   jeq A, -1, ${_E_fn_start_2}:rel + PC
44 20                          # aa1b |   inc A
